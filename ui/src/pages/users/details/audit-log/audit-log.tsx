  ...
  return (
    <Flex style={{ width: "100%" }}>
      ...
      <EmptyState
        variant="empty2"
        heading="Audit log"
        subHeading="The audit log in Aurora provides a detailed record of all key actions taken within the platform. Track user activity, monitor changes, and ensure security and compliance with a transparent activity log"
        icon={<ChipIcon />}
        primaryAction={
