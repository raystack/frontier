...
// AuthzCheckService is an autogenerated mock type for the AuthzCheckService type
type AuthzCheckService struct {
	mock.Mock
}

// CheckAuthz provides a mock function with given fields: ctx, resource, action
func (_m *AuthzCheckService) CheckAuthz(ctx context.Context, resource model.Resource, action model.Action) (bool, error) {
