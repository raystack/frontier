...
func (_m *Repository) ListGroupRelations(ctx context.Context, objectId string, subjectType string, role string) ([]relation.Relation, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) ([]relation.Relation, error)); ok {
		return rf(ctx, objectId, subjectType, role)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) []relation.Relation); ok {
...
func (_c *Repository_ListGroupRelations_Call) Return(_a0 []relation.Relation, _a1 error) *Repository_ListGroupRelations_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repository_ListGroupRelations_Call) RunAndReturn(run func(context.Context, string, string, string) ([]relation.Relation, error)) *Repository_ListGroupRelations_Call {
	_c.Call.Return(run)
	return _c
}
