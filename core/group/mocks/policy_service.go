...
func (_e *PolicyService_Expecter) GroupMemberCount(ctx interface{}, ids interface{}) *PolicyService_GroupMemberCount_Call {
	return &PolicyService_GroupMemberCount_Call{Call: _e.mock.On("GroupMemberCount", ctx, ids)}
}

func (_c *PolicyService_GroupMemberCount_Call) Run(run func(ctx context.Context, ids []string)) *PolicyService_GroupMemberCount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string))
	})
	return _c
...
func (_c *PolicyService_GroupMemberCount_Call) Return(_a0 []policy.MemberCount, _a1 error) *PolicyService_GroupMemberCount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PolicyService_GroupMemberCount_Call) RunAndReturn(run func(context.Context, []string) ([]policy.MemberCount, error)) *PolicyService_GroupMemberCount_Call {
	_c.Call.Return(run)
	return _c
}
