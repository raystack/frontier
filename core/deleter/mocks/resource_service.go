...
// Purge provides a mock function with given fields: ctx, namespaceID, id
func (_m *ResourceService) Purge(ctx context.Context, namespaceID string, id string) error {
...
// ResourceService_Purge_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Purge'
type ResourceService_Purge_Call struct {
	*mock.Call
}
...
//   - namespaceID string
//   - id string
func (_e *ResourceService_Expecter) Purge(ctx interface{}, namespaceID interface{}, id interface{}) *ResourceService_Purge_Call {
	return &ResourceService_Purge_Call{Call: _e.mock.On("Purge", ctx, namespaceID, id)}
}

func (_c *ResourceService_Purge_Call) Run(run func(ctx context.Context, namespaceID string, id string)) *ResourceService_Purge_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ResourceService_Purge_Call) Return(_a0 error) *ResourceService_Purge_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ResourceService_Purge_Call) RunAndReturn(run func(context.Context, string, string) error) *ResourceService_Purge_Call {
	_c.Call.Return(run)
	return _c
}
