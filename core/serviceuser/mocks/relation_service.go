...
func (_e *RelationService_Expecter) BatchCheckPermission(ctx interface{}, rel interface{}) *RelationService_BatchCheckPermission_Call {
	return &RelationService_BatchCheckPermission_Call{Call: _e.mock.On("BatchCheckPermission", ctx, rel)}
}

func (_c *RelationService_BatchCheckPermission_Call) Run(run func(ctx context.Context, rel []relation.Relation)) *RelationService_BatchCheckPermission_Call {
