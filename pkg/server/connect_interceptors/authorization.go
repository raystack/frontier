...
var authorizationValidationMap = map[string]func(ctx context.Context, handler *v1beta1connect.ConnectHandler, req connect.AnyRequest) error{
	...
	"/raystack.frontier.v1beta1.FrontierService/AddOrganizationMembers": func(ctx context.Context, handler *v1beta1connect.ConnectHandler, req connect.AnyRequest) error {
		pbreq := req.(*connect.Request[frontierv1beta1.AddOrganizationMembersRequest])
