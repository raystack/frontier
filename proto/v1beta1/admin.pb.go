...
var file_raystack_frontier_v1beta1_admin_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x61, 0x31, 0x2e, 0x52, 0x51, 0x4c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47, 0x72, 0x6f,
	0x75, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x05, 0x67, 0x72, 0x6f, 0x75,
	0x70, 0x32, 0xda, 0x64, 0x0a, 0x0c, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_raystack_frontier_v1beta1_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 99)
var file_raystack_frontier_v1beta1_admin_proto_goTypes = []interface{}{
	...
	nil,                                                            // 91: raystack.frontier.v1beta1.WebhookRequestBody.HeadersEntry
	(*SearchOrganizationsResponse_OrganizationResult)(nil),         // 92: raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult
	(*SearchOrganizationUsersResponse_OrganizationUser)(nil),       // 93: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.OrganizationUser
	(*SearchOrganizationProjectsResponse_OrganizationProject)(nil), // 94: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.OrganizationProject
	(*SearchProjectUsersResponse_ProjectUser)(nil),                 // 95: raystack.frontier.v1beta1.SearchProjectUsersResponse.ProjectUser
	(*SearchOrganizationInvoicesResponse_OrganizationInvoice)(nil), // 96: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.OrganizationInvoice
	(*SearchOrganizationTokensResponse_OrganizationToken)(nil),     // 97: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.OrganizationToken
	(*SearchOrganizationServiceUserCredentialsResponse_OrganizationServiceUserCredential)(nil), // 98: raystack.frontier.v1beta1.SearchOrganizationServiceUserCredentialsResponse.OrganizationServiceUserCredential
	(*User)(nil),                       // 99: raystack.frontier.v1beta1.User
	(*Group)(nil),                      // 100: raystack.frontier.v1beta1.Group
	(*Organization)(nil),               // 101: raystack.frontier.v1beta1.Organization
	(*Project)(nil),                    // 102: raystack.frontier.v1beta1.Project
	(*Relation)(nil),                   // 103: raystack.frontier.v1beta1.Relation
	(*Resource)(nil),                   // 104: raystack.frontier.v1beta1.Resource
	(*RoleRequestBody)(nil),            // 105: raystack.frontier.v1beta1.RoleRequestBody
	(*Role)(nil),                       // 106: raystack.frontier.v1beta1.Role
	(*structpb.Struct)(nil),            // 107: google.protobuf.Struct
	(*Permission)(nil),                 // 108: raystack.frontier.v1beta1.Permission
	(*Preference)(nil),                 // 109: raystack.frontier.v1beta1.Preference
	(*PreferenceRequestBody)(nil),      // 110: raystack.frontier.v1beta1.PreferenceRequestBody
	(*ServiceUser)(nil),                // 111: raystack.frontier.v1beta1.ServiceUser
	(*CheckoutSubscriptionBody)(nil),   // 112: raystack.frontier.v1beta1.CheckoutSubscriptionBody
	(*CheckoutProductBody)(nil),        // 113: raystack.frontier.v1beta1.CheckoutProductBody
	(*Subscription)(nil),               // 114: raystack.frontier.v1beta1.Subscription
	(*Product)(nil),                    // 115: raystack.frontier.v1beta1.Product
	(*Invoice)(nil),                    // 116: raystack.frontier.v1beta1.Invoice
	(*BillingAccount)(nil),             // 117: raystack.frontier.v1beta1.BillingAccount
	(*Webhook)(nil),                    // 118: raystack.frontier.v1beta1.Webhook
	(*RQLRequest)(nil),                 // 119: raystack.frontier.v1beta1.RQLRequest
	(*OrganizationKyc)(nil),            // 120: raystack.frontier.v1beta1.OrganizationKyc
	(*RQLQueryPaginationResponse)(nil), // 121: raystack.frontier.v1beta1.RQLQueryPaginationResponse
	(*RQLQueryGroupResponse)(nil),      // 122: raystack.frontier.v1beta1.RQLQueryGroupResponse
	(*Prospect)(nil),                   // 123: raystack.frontier.v1beta1.Prospect
	(Prospect_Status)(0),               // 124: raystack.frontier.v1beta1.Prospect.Status
	(*timestamppb.Timestamp)(nil),      // 125: google.protobuf.Timestamp
	(*ExportOrganizationsRequest)(nil), // 126: raystack.frontier.v1beta1.ExportOrganizationsRequest
	(*httpbody.HttpBody)(nil),          // 127: google.api.HttpBody
}
var file_raystack_frontier_v1beta1_admin_proto_depIdxs = []int32{
	99,  // 0: raystack.frontier.v1beta1.ListAllUsersResponse.users:type_name -> raystack.frontier.v1beta1.User
	100, // 1: raystack.frontier.v1beta1.ListGroupsResponse.groups:type_name -> raystack.frontier.v1beta1.Group
	101, // 2: raystack.frontier.v1beta1.ListAllOrganizationsResponse.organizations:type_name -> raystack.frontier.v1beta1.Organization
	102, // 3: raystack.frontier.v1beta1.ListProjectsResponse.projects:type_name -> raystack.frontier.v1beta1.Project
	103, // 4: raystack.frontier.v1beta1.ListRelationsResponse.relations:type_name -> raystack.frontier.v1beta1.Relation
	104, // 5: raystack.frontier.v1beta1.ListResourcesResponse.resources:type_name -> raystack.frontier.v1beta1.Resource
	105, // 6: raystack.frontier.v1beta1.CreateRoleRequest.body:type_name -> raystack.frontier.v1beta1.RoleRequestBody
	106, // 7: raystack.frontier.v1beta1.CreateRoleResponse.role:type_name -> raystack.frontier.v1beta1.Role
	105, // 8: raystack.frontier.v1beta1.UpdateRoleRequest.body:type_name -> raystack.frontier.v1beta1.RoleRequestBody
	106, // 9: raystack.frontier.v1beta1.UpdateRoleResponse.role:type_name -> raystack.frontier.v1beta1.Role
	107, // 10: raystack.frontier.v1beta1.PermissionRequestBody.metadata:type_name -> google.protobuf.Struct
	18,  // 11: raystack.frontier.v1beta1.CreatePermissionRequest.bodies:type_name -> raystack.frontier.v1beta1.PermissionRequestBody
	108, // 12: raystack.frontier.v1beta1.CreatePermissionResponse.permissions:type_name -> raystack.frontier.v1beta1.Permission
	18,  // 13: raystack.frontier.v1beta1.UpdatePermissionRequest.body:type_name -> raystack.frontier.v1beta1.PermissionRequestBody
	108, // 14: raystack.frontier.v1beta1.UpdatePermissionResponse.permission:type_name -> raystack.frontier.v1beta1.Permission
	109, // 15: raystack.frontier.v1beta1.ListPreferencesResponse.preferences:type_name -> raystack.frontier.v1beta1.Preference
	110, // 16: raystack.frontier.v1beta1.CreatePreferencesRequest.preferences:type_name -> raystack.frontier.v1beta1.PreferenceRequestBody
	109, // 17: raystack.frontier.v1beta1.CreatePreferencesResponse.preference:type_name -> raystack.frontier.v1beta1.Preference
	99,  // 18: raystack.frontier.v1beta1.ListPlatformUsersResponse.users:type_name -> raystack.frontier.v1beta1.User
	111, // 19: raystack.frontier.v1beta1.ListPlatformUsersResponse.serviceusers:type_name -> raystack.frontier.v1beta1.ServiceUser
	112, // 20: raystack.frontier.v1beta1.DelegatedCheckoutRequest.subscription_body:type_name -> raystack.frontier.v1beta1.CheckoutSubscriptionBody
	113, // 21: raystack.frontier.v1beta1.DelegatedCheckoutRequest.product_body:type_name -> raystack.frontier.v1beta1.CheckoutProductBody
	114, // 22: raystack.frontier.v1beta1.DelegatedCheckoutResponse.subscription:type_name -> raystack.frontier.v1beta1.Subscription
	115, // 23: raystack.frontier.v1beta1.DelegatedCheckoutResponse.product:type_name -> raystack.frontier.v1beta1.Product
	116, // 24: raystack.frontier.v1beta1.ListAllInvoicesResponse.invoices:type_name -> raystack.frontier.v1beta1.Invoice
	117, // 25: raystack.frontier.v1beta1.ListAllBillingAccountsResponse.billing_accounts:type_name -> raystack.frontier.v1beta1.BillingAccount
	91,  // 26: raystack.frontier.v1beta1.WebhookRequestBody.headers:type_name -> raystack.frontier.v1beta1.WebhookRequestBody.HeadersEntry
	107, // 27: raystack.frontier.v1beta1.WebhookRequestBody.metadata:type_name -> google.protobuf.Struct
	47,  // 28: raystack.frontier.v1beta1.CreateWebhookRequest.body:type_name -> raystack.frontier.v1beta1.WebhookRequestBody
	118, // 29: raystack.frontier.v1beta1.CreateWebhookResponse.webhook:type_name -> raystack.frontier.v1beta1.Webhook
	47,  // 30: raystack.frontier.v1beta1.UpdateWebhookRequest.body:type_name -> raystack.frontier.v1beta1.WebhookRequestBody
	118, // 31: raystack.frontier.v1beta1.UpdateWebhookResponse.webhook:type_name -> raystack.frontier.v1beta1.Webhook
	118, // 32: raystack.frontier.v1beta1.ListWebhooksResponse.webhooks:type_name -> raystack.frontier.v1beta1.Webhook
	119, // 33: raystack.frontier.v1beta1.SearchOrganizationsRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	120, // 34: raystack.frontier.v1beta1.SetOrganizationKycResponse.organization_kyc:type_name -> raystack.frontier.v1beta1.OrganizationKyc
	120, // 35: raystack.frontier.v1beta1.ListOrganizationsKycResponse.organizations_kyc:type_name -> raystack.frontier.v1beta1.OrganizationKyc
	92,  // 36: raystack.frontier.v1beta1.SearchOrganizationsResponse.organizations:type_name -> raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult
	121, // 37: raystack.frontier.v1beta1.SearchOrganizationsResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	122, // 38: raystack.frontier.v1beta1.SearchOrganizationsResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	119, // 39: raystack.frontier.v1beta1.ListProspectsRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	123, // 40: raystack.frontier.v1beta1.ListProspectsResponse.prospects:type_name -> raystack.frontier.v1beta1.Prospect
	121, // 41: raystack.frontier.v1beta1.ListProspectsResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	122, // 42: raystack.frontier.v1beta1.ListProspectsResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	123, // 43: raystack.frontier.v1beta1.GetProspectResponse.prospect:type_name -> raystack.frontier.v1beta1.Prospect
	124, // 44: raystack.frontier.v1beta1.UpdateProspectRequest.status:type_name -> raystack.frontier.v1beta1.Prospect.Status
	107, // 45: raystack.frontier.v1beta1.UpdateProspectRequest.metadata:type_name -> google.protobuf.Struct
	123, // 46: raystack.frontier.v1beta1.UpdateProspectResponse.prospect:type_name -> raystack.frontier.v1beta1.Prospect
	124, // 47: raystack.frontier.v1beta1.CreateProspectRequest.status:type_name -> raystack.frontier.v1beta1.Prospect.Status
	107, // 48: raystack.frontier.v1beta1.CreateProspectRequest.metadata:type_name -> google.protobuf.Struct
	123, // 49: raystack.frontier.v1beta1.CreateProspectResponse.prospect:type_name -> raystack.frontier.v1beta1.Prospect
	119, // 50: raystack.frontier.v1beta1.SearchOrganizationUsersRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	93,  // 51: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.org_users:type_name -> raystack.frontier.v1beta1.SearchOrganizationUsersResponse.OrganizationUser
	121, // 52: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	122, // 53: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	119, // 54: raystack.frontier.v1beta1.SearchOrganizationProjectsRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	94,  // 55: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.org_projects:type_name -> raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.OrganizationProject
	121, // 56: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	122, // 57: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	119, // 58: raystack.frontier.v1beta1.SearchProjectUsersRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	95,  // 59: raystack.frontier.v1beta1.SearchProjectUsersResponse.project_users:type_name -> raystack.frontier.v1beta1.SearchProjectUsersResponse.ProjectUser
	121, // 60: raystack.frontier.v1beta1.SearchProjectUsersResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	122, // 61: raystack.frontier.v1beta1.SearchProjectUsersResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	119, // 62: raystack.frontier.v1beta1.SearchOrganizationInvoicesRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	96,  // 63: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.organization_invoices:type_name -> raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.OrganizationInvoice
	121, // 64: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	122, // 65: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	119, // 66: raystack.frontier.v1beta1.SearchOrganizationTokensRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	97,  // 67: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.organization_tokens:type_name -> raystack.frontier.v1beta1.SearchOrganizationTokensResponse.OrganizationToken
	121, // 68: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	122, // 69: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	119, // 70: raystack.frontier.v1beta1.SearchOrganizationServiceUserCredentialsRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	98,  // 71: raystack.frontier.v1beta1.SearchOrganizationServiceUserCredentialsResponse.organization_serviceuser_credentials:type_name -> raystack.frontier.v1beta1.SearchOrganizationServiceUserCredentialsResponse.OrganizationServiceUserCredential
	121, // 72: raystack.frontier.v1beta1.SearchOrganizationServiceUserCredentialsResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	122, // 73: raystack.frontier.v1beta1.SearchOrganizationServiceUserCredentialsResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	119, // 74: raystack.frontier.v1beta1.SearchUsersRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	99,  // 75: raystack.frontier.v1beta1.SearchUsersResponse.users:type_name -> raystack.frontier.v1beta1.User
	121, // 76: raystack.frontier.v1beta1.SearchUsersResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	122, // 77: raystack.frontier.v1beta1.SearchUsersResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	125, // 78: raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult.created_at:type_name -> google.protobuf.Timestamp
	125, // 79: raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult.updated_at:type_name -> google.protobuf.Timestamp
	125, // 80: raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult.subscription_cycle_end_at:type_name -> google.protobuf.Timestamp
	125, // 81: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.OrganizationUser.org_joined_at:type_name -> google.protobuf.Timestamp
	125, // 82: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.OrganizationProject.created_at:type_name -> google.protobuf.Timestamp
	125, // 83: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.OrganizationInvoice.created_at:type_name -> google.protobuf.Timestamp
	125, // 84: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.OrganizationToken.created_at:type_name -> google.protobuf.Timestamp
	125, // 85: raystack.frontier.v1beta1.SearchOrganizationServiceUserCredentialsResponse.OrganizationServiceUserCredential.created_at:type_name -> google.protobuf.Timestamp
	...
	126, // 96: raystack.frontier.v1beta1.AdminService.ExportOrganizations:input_type -> raystack.frontier.v1beta1.ExportOrganizationsRequest
	...
	89,  // 100: raystack.frontier.v1beta1.AdminService.SearchUsers:input_type -> raystack.frontier.v1beta1.SearchUsersRequest
	58,  // 101: raystack.frontier.v1beta1.AdminService.SetOrganizationKyc:input_type -> raystack.frontier.v1beta1.SetOrganizationKycRequest
	61,  // 102: raystack.frontier.v1beta1.AdminService.ListOrganizationsKyc:input_type -> raystack.frontier.v1beta1.ListOrganizationsKycRequest
	6,   // 103: raystack.frontier.v1beta1.AdminService.ListProjects:input_type -> raystack.frontier.v1beta1.ListProjectsRequest
	8,   // 104: raystack.frontier.v1beta1.AdminService.ListRelations:input_type -> raystack.frontier.v1beta1.ListRelationsRequest
	10,  // 105: raystack.frontier.v1beta1.AdminService.ListResources:input_type -> raystack.frontier.v1beta1.ListResourcesRequest
	12,  // 106: raystack.frontier.v1beta1.AdminService.CreateRole:input_type -> raystack.frontier.v1beta1.CreateRoleRequest
	14,  // 107: raystack.frontier.v1beta1.AdminService.UpdateRole:input_type -> raystack.frontier.v1beta1.UpdateRoleRequest
	16,  // 108: raystack.frontier.v1beta1.AdminService.DeleteRole:input_type -> raystack.frontier.v1beta1.DeleteRoleRequest
	19,  // 109: raystack.frontier.v1beta1.AdminService.CreatePermission:input_type -> raystack.frontier.v1beta1.CreatePermissionRequest
	21,  // 110: raystack.frontier.v1beta1.AdminService.UpdatePermission:input_type -> raystack.frontier.v1beta1.UpdatePermissionRequest
	23,  // 111: raystack.frontier.v1beta1.AdminService.DeletePermission:input_type -> raystack.frontier.v1beta1.DeletePermissionRequest
	25,  // 112: raystack.frontier.v1beta1.AdminService.ListPreferences:input_type -> raystack.frontier.v1beta1.ListPreferencesRequest
	27,  // 113: raystack.frontier.v1beta1.AdminService.CreatePreferences:input_type -> raystack.frontier.v1beta1.CreatePreferencesRequest
	29,  // 114: raystack.frontier.v1beta1.AdminService.CheckFederatedResourcePermission:input_type -> raystack.frontier.v1beta1.CheckFederatedResourcePermissionRequest
	31,  // 115: raystack.frontier.v1beta1.AdminService.AddPlatformUser:input_type -> raystack.frontier.v1beta1.AddPlatformUserRequest
	33,  // 116: raystack.frontier.v1beta1.AdminService.ListPlatformUsers:input_type -> raystack.frontier.v1beta1.ListPlatformUsersRequest
	35,  // 117: raystack.frontier.v1beta1.AdminService.RemovePlatformUser:input_type -> raystack.frontier.v1beta1.RemovePlatformUserRequest
	37,  // 118: raystack.frontier.v1beta1.AdminService.DelegatedCheckout:input_type -> raystack.frontier.v1beta1.DelegatedCheckoutRequest
	39,  // 119: raystack.frontier.v1beta1.AdminService.ListAllInvoices:input_type -> raystack.frontier.v1beta1.ListAllInvoicesRequest
	41,  // 120: raystack.frontier.v1beta1.AdminService.GenerateInvoices:input_type -> raystack.frontier.v1beta1.GenerateInvoicesRequest
	43,  // 121: raystack.frontier.v1beta1.AdminService.ListAllBillingAccounts:input_type -> raystack.frontier.v1beta1.ListAllBillingAccountsRequest
	45,  // 122: raystack.frontier.v1beta1.AdminService.RevertBillingUsage:input_type -> raystack.frontier.v1beta1.RevertBillingUsageRequest
	48,  // 123: raystack.frontier.v1beta1.AdminService.CreateWebhook:input_type -> raystack.frontier.v1beta1.CreateWebhookRequest
	50,  // 124: raystack.frontier.v1beta1.AdminService.UpdateWebhook:input_type -> raystack.frontier.v1beta1.UpdateWebhookRequest
	52,  // 125: raystack.frontier.v1beta1.AdminService.DeleteWebhook:input_type -> raystack.frontier.v1beta1.DeleteWebhookRequest
	54,  // 126: raystack.frontier.v1beta1.AdminService.ListWebhooks:input_type -> raystack.frontier.v1beta1.ListWebhooksRequest
	56,  // 127: raystack.frontier.v1beta1.AdminService.UpdateBillingAccountLimits:input_type -> raystack.frontier.v1beta1.UpdateBillingAccountLimitsRequest
	72,  // 128: raystack.frontier.v1beta1.AdminService.CreateProspect:input_type -> raystack.frontier.v1beta1.CreateProspectRequest
	64,  // 129: raystack.frontier.v1beta1.AdminService.ListProspects:input_type -> raystack.frontier.v1beta1.ListProspectsRequest
	66,  // 130: raystack.frontier.v1beta1.AdminService.GetProspect:input_type -> raystack.frontier.v1beta1.GetProspectRequest
	68,  // 131: raystack.frontier.v1beta1.AdminService.UpdateProspect:input_type -> raystack.frontier.v1beta1.UpdateProspectRequest
	70,  // 132: raystack.frontier.v1beta1.AdminService.DeleteProspect:input_type -> raystack.frontier.v1beta1.DeleteProspectRequest
	1,   // 133: raystack.frontier.v1beta1.AdminService.ListAllUsers:output_type -> raystack.frontier.v1beta1.ListAllUsersResponse
	3,   // 134: raystack.frontier.v1beta1.AdminService.ListGroups:output_type -> raystack.frontier.v1beta1.ListGroupsResponse
	5,   // 135: raystack.frontier.v1beta1.AdminService.ListAllOrganizations:output_type -> raystack.frontier.v1beta1.ListAllOrganizationsResponse
	63,  // 136: raystack.frontier.v1beta1.AdminService.SearchOrganizations:output_type -> raystack.frontier.v1beta1.SearchOrganizationsResponse
	75,  // 137: raystack.frontier.v1beta1.AdminService.SearchOrganizationUsers:output_type -> raystack.frontier.v1beta1.SearchOrganizationUsersResponse
	81,  // 138: raystack.frontier.v1beta1.AdminService.SearchProjectUsers:output_type -> raystack.frontier.v1beta1.SearchProjectUsersResponse
	78,  // 139: raystack.frontier.v1beta1.AdminService.SearchOrganizationProjects:output_type -> raystack.frontier.v1beta1.SearchOrganizationProjectsResponse
	83,  // 140: raystack.frontier.v1beta1.AdminService.SearchOrganizationInvoices:output_type -> raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse
	85,  // 141: raystack.frontier.v1beta1.AdminService.SearchOrganizationTokens:output_type -> raystack.frontier.v1beta1.SearchOrganizationTokensResponse
	88,  // 142: raystack.frontier.v1beta1.AdminService.SearchOrganizationServiceUserCredentials:output_type -> raystack.frontier.v1beta1.SearchOrganizationServiceUserCredentialsResponse
	127, // 143: raystack.frontier.v1beta1.AdminService.ExportOrganizations:output_type -> google.api.HttpBody
	127, // 144: raystack.frontier.v1beta1.AdminService.ExportOrganizationUsers:output_type -> google.api.HttpBody
	127, // 145: raystack.frontier.v1beta1.AdminService.ExportOrganizationProjects:output_type -> google.api.HttpBody
	127, // 146: raystack.frontier.v1beta1.AdminService.ExportOrganizationTokens:output_type -> google.api.HttpBody
	90,  // 147: raystack.frontier.v1beta1.AdminService.SearchUsers:output_type -> raystack.frontier.v1beta1.SearchUsersResponse
	60,  // 148: raystack.frontier.v1beta1.AdminService.SetOrganizationKyc:output_type -> raystack.frontier.v1beta1.SetOrganizationKycResponse
	62,  // 149: raystack.frontier.v1beta1.AdminService.ListOrganizationsKyc:output_type -> raystack.frontier.v1beta1.ListOrganizationsKycResponse
	7,   // 150: raystack.frontier.v1beta1.AdminService.ListProjects:output_type -> raystack.frontier.v1beta1.ListProjectsResponse
	9,   // 151: raystack.frontier.v1beta1.AdminService.ListRelations:output_type -> raystack.frontier.v1beta1.ListRelationsResponse
	11,  // 152: raystack.frontier.v1beta1.AdminService.ListResources:output_type -> raystack.frontier.v1beta1.ListResourcesResponse
	13,  // 153: raystack.frontier.v1beta1.AdminService.CreateRole:output_type -> raystack.frontier.v1beta1.CreateRoleResponse
	15,  // 154: raystack.frontier.v1beta1.AdminService.UpdateRole:output_type -> raystack.frontier.v1beta1.UpdateRoleResponse
	17,  // 155: raystack.frontier.v1beta1.AdminService.DeleteRole:output_type -> raystack.frontier.v1beta1.DeleteRoleResponse
	20,  // 156: raystack.frontier.v1beta1.AdminService.CreatePermission:output_type -> raystack.frontier.v1beta1.CreatePermissionResponse
	22,  // 157: raystack.frontier.v1beta1.AdminService.UpdatePermission:output_type -> raystack.frontier.v1beta1.UpdatePermissionResponse
	24,  // 158: raystack.frontier.v1beta1.AdminService.DeletePermission:output_type -> raystack.frontier.v1beta1.DeletePermissionResponse
	26,  // 159: raystack.frontier.v1beta1.AdminService.ListPreferences:output_type -> raystack.frontier.v1beta1.ListPreferencesResponse
	28,  // 160: raystack.frontier.v1beta1.AdminService.CreatePreferences:output_type -> raystack.frontier.v1beta1.CreatePreferencesResponse
	30,  // 161: raystack.frontier.v1beta1.AdminService.CheckFederatedResourcePermission:output_type -> raystack.frontier.v1beta1.CheckFederatedResourcePermissionResponse
	32,  // 162: raystack.frontier.v1beta1.AdminService.AddPlatformUser:output_type -> raystack.frontier.v1beta1.AddPlatformUserResponse
	34,  // 163: raystack.frontier.v1beta1.AdminService.ListPlatformUsers:output_type -> raystack.frontier.v1beta1.ListPlatformUsersResponse
	36,  // 164: raystack.frontier.v1beta1.AdminService.RemovePlatformUser:output_type -> raystack.frontier.v1beta1.RemovePlatformUserResponse
	38,  // 165: raystack.frontier.v1beta1.AdminService.DelegatedCheckout:output_type -> raystack.frontier.v1beta1.DelegatedCheckoutResponse
	40,  // 166: raystack.frontier.v1beta1.AdminService.ListAllInvoices:output_type -> raystack.frontier.v1beta1.ListAllInvoicesResponse
	42,  // 167: raystack.frontier.v1beta1.AdminService.GenerateInvoices:output_type -> raystack.frontier.v1beta1.GenerateInvoicesResponse
	44,  // 168: raystack.frontier.v1beta1.AdminService.ListAllBillingAccounts:output_type -> raystack.frontier.v1beta1.ListAllBillingAccountsResponse
	46,  // 169: raystack.frontier.v1beta1.AdminService.RevertBillingUsage:output_type -> raystack.frontier.v1beta1.RevertBillingUsageResponse
	49,  // 170: raystack.frontier.v1beta1.AdminService.CreateWebhook:output_type -> raystack.frontier.v1beta1.CreateWebhookResponse
	51,  // 171: raystack.frontier.v1beta1.AdminService.UpdateWebhook:output_type -> raystack.frontier.v1beta1.UpdateWebhookResponse
	53,  // 172: raystack.frontier.v1beta1.AdminService.DeleteWebhook:output_type -> raystack.frontier.v1beta1.DeleteWebhookResponse
	55,  // 173: raystack.frontier.v1beta1.AdminService.ListWebhooks:output_type -> raystack.frontier.v1beta1.ListWebhooksResponse
	57,  // 174: raystack.frontier.v1beta1.AdminService.UpdateBillingAccountLimits:output_type -> raystack.frontier.v1beta1.UpdateBillingAccountLimitsResponse
	73,  // 175: raystack.frontier.v1beta1.AdminService.CreateProspect:output_type -> raystack.frontier.v1beta1.CreateProspectResponse
	65,  // 176: raystack.frontier.v1beta1.AdminService.ListProspects:output_type -> raystack.frontier.v1beta1.ListProspectsResponse
	67,  // 177: raystack.frontier.v1beta1.AdminService.GetProspect:output_type -> raystack.frontier.v1beta1.GetProspectResponse
	69,  // 178: raystack.frontier.v1beta1.AdminService.UpdateProspect:output_type -> raystack.frontier.v1beta1.UpdateProspectResponse
	71,  // 179: raystack.frontier.v1beta1.AdminService.DeleteProspect:output_type -> raystack.frontier.v1beta1.DeleteProspectResponse
	133, // [133:180] is the sub-list for method output_type
	86,  // [86:133] is the sub-list for method input_type
