...
var file_raystack_frontier_v1beta1_admin_proto_rawDesc = []byte{
	...
	0x64, 0x32, 0x8d, 0x5c, 0x0a, 0x0c, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x6e, 0x73, 0x2f, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x8d, 0x02, 0x0a, 0x13, 0x45, 0x78,
...
var file_raystack_frontier_v1beta1_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 91)
var file_raystack_frontier_v1beta1_admin_proto_goTypes = []interface{}{
	...
	nil,                                                            // 84: raystack.frontier.v1beta1.WebhookRequestBody.HeadersEntry
	(*SearchOrganizationsResponse_OrganizationResult)(nil),         // 85: raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult
	(*SearchOrganizationUsersResponse_OrganizationUser)(nil),       // 86: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.OrganizationUser
	(*SearchOrganizationProjectsResponse_OrganizationProject)(nil), // 87: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.OrganizationProject
	(*SearchProjectUsersResponse_ProjectUser)(nil),                 // 88: raystack.frontier.v1beta1.SearchProjectUsersResponse.ProjectUser
	(*SearchOrganizationInvoicesResponse_OrganizationInvoice)(nil), // 89: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.OrganizationInvoice
	(*SearchOrganizationTokensResponse_OrganizationToken)(nil),     // 90: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.OrganizationToken
	(*User)(nil),                       // 91: raystack.frontier.v1beta1.User
	(*Group)(nil),                      // 92: raystack.frontier.v1beta1.Group
	(*Organization)(nil),               // 93: raystack.frontier.v1beta1.Organization
	(*Project)(nil),                    // 94: raystack.frontier.v1beta1.Project
	(*Relation)(nil),                   // 95: raystack.frontier.v1beta1.Relation
	(*Resource)(nil),                   // 96: raystack.frontier.v1beta1.Resource
	(*RoleRequestBody)(nil),            // 97: raystack.frontier.v1beta1.RoleRequestBody
	(*Role)(nil),                       // 98: raystack.frontier.v1beta1.Role
	(*structpb.Struct)(nil),            // 99: google.protobuf.Struct
	(*Permission)(nil),                 // 100: raystack.frontier.v1beta1.Permission
	(*Preference)(nil),                 // 101: raystack.frontier.v1beta1.Preference
	(*PreferenceRequestBody)(nil),      // 102: raystack.frontier.v1beta1.PreferenceRequestBody
	(*ServiceUser)(nil),                // 103: raystack.frontier.v1beta1.ServiceUser
	(*CheckoutSubscriptionBody)(nil),   // 104: raystack.frontier.v1beta1.CheckoutSubscriptionBody
	(*CheckoutProductBody)(nil),        // 105: raystack.frontier.v1beta1.CheckoutProductBody
	(*Subscription)(nil),               // 106: raystack.frontier.v1beta1.Subscription
	(*Product)(nil),                    // 107: raystack.frontier.v1beta1.Product
	(*Invoice)(nil),                    // 108: raystack.frontier.v1beta1.Invoice
	(*BillingAccount)(nil),             // 109: raystack.frontier.v1beta1.BillingAccount
	(*Webhook)(nil),                    // 110: raystack.frontier.v1beta1.Webhook
	(*RQLRequest)(nil),                 // 111: raystack.frontier.v1beta1.RQLRequest
	(*OrganizationKyc)(nil),            // 112: raystack.frontier.v1beta1.OrganizationKyc
	(*RQLQueryPaginationResponse)(nil), // 113: raystack.frontier.v1beta1.RQLQueryPaginationResponse
	(*RQLQueryGroupResponse)(nil),      // 114: raystack.frontier.v1beta1.RQLQueryGroupResponse
	(*Prospect)(nil),                   // 115: raystack.frontier.v1beta1.Prospect
	(Prospect_Status)(0),               // 116: raystack.frontier.v1beta1.Prospect.Status
	(*timestamppb.Timestamp)(nil),      // 117: google.protobuf.Timestamp
	(*ExportOrganizationsRequest)(nil), // 118: raystack.frontier.v1beta1.ExportOrganizationsRequest
	(*httpbody.HttpBody)(nil),          // 119: google.api.HttpBody
}
var file_raystack_frontier_v1beta1_admin_proto_depIdxs = []int32{
	91,  // 0: raystack.frontier.v1beta1.ListAllUsersResponse.users:type_name -> raystack.frontier.v1beta1.User
	92,  // 1: raystack.frontier.v1beta1.ListGroupsResponse.groups:type_name -> raystack.frontier.v1beta1.Group
	93,  // 2: raystack.frontier.v1beta1.ListAllOrganizationsResponse.organizations:type_name -> raystack.frontier.v1beta1.Organization
	94,  // 3: raystack.frontier.v1beta1.ListProjectsResponse.projects:type_name -> raystack.frontier.v1beta1.Project
	95,  // 4: raystack.frontier.v1beta1.ListRelationsResponse.relations:type_name -> raystack.frontier.v1beta1.Relation
	96,  // 5: raystack.frontier.v1beta1.ListResourcesResponse.resources:type_name -> raystack.frontier.v1beta1.Resource
	97,  // 6: raystack.frontier.v1beta1.CreateRoleRequest.body:type_name -> raystack.frontier.v1beta1.RoleRequestBody
	98,  // 7: raystack.frontier.v1beta1.CreateRoleResponse.role:type_name -> raystack.frontier.v1beta1.Role
	97,  // 8: raystack.frontier.v1beta1.UpdateRoleRequest.body:type_name -> raystack.frontier.v1beta1.RoleRequestBody
	98,  // 9: raystack.frontier.v1beta1.UpdateRoleResponse.role:type_name -> raystack.frontier.v1beta1.Role
	99,  // 10: raystack.frontier.v1beta1.PermissionRequestBody.metadata:type_name -> google.protobuf.Struct
	18,  // 11: raystack.frontier.v1beta1.CreatePermissionRequest.bodies:type_name -> raystack.frontier.v1beta1.PermissionRequestBody
	100, // 12: raystack.frontier.v1beta1.CreatePermissionResponse.permissions:type_name -> raystack.frontier.v1beta1.Permission
	18,  // 13: raystack.frontier.v1beta1.UpdatePermissionRequest.body:type_name -> raystack.frontier.v1beta1.PermissionRequestBody
	100, // 14: raystack.frontier.v1beta1.UpdatePermissionResponse.permission:type_name -> raystack.frontier.v1beta1.Permission
	101, // 15: raystack.frontier.v1beta1.ListPreferencesResponse.preferences:type_name -> raystack.frontier.v1beta1.Preference
	102, // 16: raystack.frontier.v1beta1.CreatePreferencesRequest.preferences:type_name -> raystack.frontier.v1beta1.PreferenceRequestBody
	101, // 17: raystack.frontier.v1beta1.CreatePreferencesResponse.preference:type_name -> raystack.frontier.v1beta1.Preference
	91,  // 18: raystack.frontier.v1beta1.ListPlatformUsersResponse.users:type_name -> raystack.frontier.v1beta1.User
	103, // 19: raystack.frontier.v1beta1.ListPlatformUsersResponse.serviceusers:type_name -> raystack.frontier.v1beta1.ServiceUser
	104, // 20: raystack.frontier.v1beta1.DelegatedCheckoutRequest.subscription_body:type_name -> raystack.frontier.v1beta1.CheckoutSubscriptionBody
	105, // 21: raystack.frontier.v1beta1.DelegatedCheckoutRequest.product_body:type_name -> raystack.frontier.v1beta1.CheckoutProductBody
	106, // 22: raystack.frontier.v1beta1.DelegatedCheckoutResponse.subscription:type_name -> raystack.frontier.v1beta1.Subscription
	107, // 23: raystack.frontier.v1beta1.DelegatedCheckoutResponse.product:type_name -> raystack.frontier.v1beta1.Product
	108, // 24: raystack.frontier.v1beta1.ListAllInvoicesResponse.invoices:type_name -> raystack.frontier.v1beta1.Invoice
	109, // 25: raystack.frontier.v1beta1.ListAllBillingAccountsResponse.billing_accounts:type_name -> raystack.frontier.v1beta1.BillingAccount
	84,  // 26: raystack.frontier.v1beta1.WebhookRequestBody.headers:type_name -> raystack.frontier.v1beta1.WebhookRequestBody.HeadersEntry
	99,  // 27: raystack.frontier.v1beta1.WebhookRequestBody.metadata:type_name -> google.protobuf.Struct
	47,  // 28: raystack.frontier.v1beta1.CreateWebhookRequest.body:type_name -> raystack.frontier.v1beta1.WebhookRequestBody
	110, // 29: raystack.frontier.v1beta1.CreateWebhookResponse.webhook:type_name -> raystack.frontier.v1beta1.Webhook
	47,  // 30: raystack.frontier.v1beta1.UpdateWebhookRequest.body:type_name -> raystack.frontier.v1beta1.WebhookRequestBody
	110, // 31: raystack.frontier.v1beta1.UpdateWebhookResponse.webhook:type_name -> raystack.frontier.v1beta1.Webhook
	110, // 32: raystack.frontier.v1beta1.ListWebhooksResponse.webhooks:type_name -> raystack.frontier.v1beta1.Webhook
	111, // 33: raystack.frontier.v1beta1.SearchOrganizationsRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	112, // 34: raystack.frontier.v1beta1.SetOrganizationKycResponse.organization_kyc:type_name -> raystack.frontier.v1beta1.OrganizationKyc
	85,  // 35: raystack.frontier.v1beta1.SearchOrganizationsResponse.organizations:type_name -> raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult
	113, // 36: raystack.frontier.v1beta1.SearchOrganizationsResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	114, // 37: raystack.frontier.v1beta1.SearchOrganizationsResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	111, // 38: raystack.frontier.v1beta1.ListProspectsRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	115, // 39: raystack.frontier.v1beta1.ListProspectsResponse.prospects:type_name -> raystack.frontier.v1beta1.Prospect
	113, // 40: raystack.frontier.v1beta1.ListProspectsResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	114, // 41: raystack.frontier.v1beta1.ListProspectsResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	115, // 42: raystack.frontier.v1beta1.GetProspectResponse.prospect:type_name -> raystack.frontier.v1beta1.Prospect
	116, // 43: raystack.frontier.v1beta1.UpdateProspectRequest.status:type_name -> raystack.frontier.v1beta1.Prospect.Status
	99,  // 44: raystack.frontier.v1beta1.UpdateProspectRequest.metadata:type_name -> google.protobuf.Struct
	115, // 45: raystack.frontier.v1beta1.UpdateProspectResponse.prospect:type_name -> raystack.frontier.v1beta1.Prospect
	116, // 46: raystack.frontier.v1beta1.CreateProspectRequest.status:type_name -> raystack.frontier.v1beta1.Prospect.Status
	99,  // 47: raystack.frontier.v1beta1.CreateProspectRequest.metadata:type_name -> google.protobuf.Struct
	115, // 48: raystack.frontier.v1beta1.CreateProspectResponse.prospect:type_name -> raystack.frontier.v1beta1.Prospect
	111, // 49: raystack.frontier.v1beta1.SearchOrganizationUsersRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	86,  // 50: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.org_users:type_name -> raystack.frontier.v1beta1.SearchOrganizationUsersResponse.OrganizationUser
	113, // 51: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	114, // 52: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	111, // 53: raystack.frontier.v1beta1.SearchOrganizationProjectsRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	87,  // 54: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.org_projects:type_name -> raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.OrganizationProject
	113, // 55: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	114, // 56: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	111, // 57: raystack.frontier.v1beta1.SearchProjectUsersRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	88,  // 58: raystack.frontier.v1beta1.SearchProjectUsersResponse.project_users:type_name -> raystack.frontier.v1beta1.SearchProjectUsersResponse.ProjectUser
	113, // 59: raystack.frontier.v1beta1.SearchProjectUsersResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	114, // 60: raystack.frontier.v1beta1.SearchProjectUsersResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	111, // 61: raystack.frontier.v1beta1.SearchOrganizationInvoicesRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	89,  // 62: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.organization_invoices:type_name -> raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.OrganizationInvoice
	113, // 63: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	114, // 64: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	111, // 65: raystack.frontier.v1beta1.SearchOrganizationTokensRequest.query:type_name -> raystack.frontier.v1beta1.RQLRequest
	90,  // 66: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.organization_tokens:type_name -> raystack.frontier.v1beta1.SearchOrganizationTokensResponse.OrganizationToken
	113, // 67: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.pagination:type_name -> raystack.frontier.v1beta1.RQLQueryPaginationResponse
	114, // 68: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.group:type_name -> raystack.frontier.v1beta1.RQLQueryGroupResponse
	117, // 69: raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult.created_at:type_name -> google.protobuf.Timestamp
	117, // 70: raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult.updated_at:type_name -> google.protobuf.Timestamp
	117, // 71: raystack.frontier.v1beta1.SearchOrganizationsResponse.OrganizationResult.subscription_cycle_end_at:type_name -> google.protobuf.Timestamp
	117, // 72: raystack.frontier.v1beta1.SearchOrganizationUsersResponse.OrganizationUser.org_joined_at:type_name -> google.protobuf.Timestamp
	117, // 73: raystack.frontier.v1beta1.SearchOrganizationProjectsResponse.OrganizationProject.created_at:type_name -> google.protobuf.Timestamp
	117, // 74: raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse.OrganizationInvoice.created_at:type_name -> google.protobuf.Timestamp
	117, // 75: raystack.frontier.v1beta1.SearchOrganizationTokensResponse.OrganizationToken.created_at:type_name -> google.protobuf.Timestamp
	...
	118, // 85: raystack.frontier.v1beta1.AdminService.ExportOrganizations:input_type -> raystack.frontier.v1beta1.ExportOrganizationsRequest
	...
	58,  // 88: raystack.frontier.v1beta1.AdminService.SetOrganizationKyc:input_type -> raystack.frontier.v1beta1.SetOrganizationKycRequest
	6,   // 89: raystack.frontier.v1beta1.AdminService.ListProjects:input_type -> raystack.frontier.v1beta1.ListProjectsRequest
	8,   // 90: raystack.frontier.v1beta1.AdminService.ListRelations:input_type -> raystack.frontier.v1beta1.ListRelationsRequest
	10,  // 91: raystack.frontier.v1beta1.AdminService.ListResources:input_type -> raystack.frontier.v1beta1.ListResourcesRequest
	12,  // 92: raystack.frontier.v1beta1.AdminService.CreateRole:input_type -> raystack.frontier.v1beta1.CreateRoleRequest
	14,  // 93: raystack.frontier.v1beta1.AdminService.UpdateRole:input_type -> raystack.frontier.v1beta1.UpdateRoleRequest
	16,  // 94: raystack.frontier.v1beta1.AdminService.DeleteRole:input_type -> raystack.frontier.v1beta1.DeleteRoleRequest
	19,  // 95: raystack.frontier.v1beta1.AdminService.CreatePermission:input_type -> raystack.frontier.v1beta1.CreatePermissionRequest
	21,  // 96: raystack.frontier.v1beta1.AdminService.UpdatePermission:input_type -> raystack.frontier.v1beta1.UpdatePermissionRequest
	23,  // 97: raystack.frontier.v1beta1.AdminService.DeletePermission:input_type -> raystack.frontier.v1beta1.DeletePermissionRequest
	25,  // 98: raystack.frontier.v1beta1.AdminService.ListPreferences:input_type -> raystack.frontier.v1beta1.ListPreferencesRequest
	27,  // 99: raystack.frontier.v1beta1.AdminService.CreatePreferences:input_type -> raystack.frontier.v1beta1.CreatePreferencesRequest
	29,  // 100: raystack.frontier.v1beta1.AdminService.CheckFederatedResourcePermission:input_type -> raystack.frontier.v1beta1.CheckFederatedResourcePermissionRequest
	31,  // 101: raystack.frontier.v1beta1.AdminService.AddPlatformUser:input_type -> raystack.frontier.v1beta1.AddPlatformUserRequest
	33,  // 102: raystack.frontier.v1beta1.AdminService.ListPlatformUsers:input_type -> raystack.frontier.v1beta1.ListPlatformUsersRequest
	35,  // 103: raystack.frontier.v1beta1.AdminService.RemovePlatformUser:input_type -> raystack.frontier.v1beta1.RemovePlatformUserRequest
	37,  // 104: raystack.frontier.v1beta1.AdminService.DelegatedCheckout:input_type -> raystack.frontier.v1beta1.DelegatedCheckoutRequest
	39,  // 105: raystack.frontier.v1beta1.AdminService.ListAllInvoices:input_type -> raystack.frontier.v1beta1.ListAllInvoicesRequest
	41,  // 106: raystack.frontier.v1beta1.AdminService.GenerateInvoices:input_type -> raystack.frontier.v1beta1.GenerateInvoicesRequest
	43,  // 107: raystack.frontier.v1beta1.AdminService.ListAllBillingAccounts:input_type -> raystack.frontier.v1beta1.ListAllBillingAccountsRequest
	45,  // 108: raystack.frontier.v1beta1.AdminService.RevertBillingUsage:input_type -> raystack.frontier.v1beta1.RevertBillingUsageRequest
	48,  // 109: raystack.frontier.v1beta1.AdminService.CreateWebhook:input_type -> raystack.frontier.v1beta1.CreateWebhookRequest
	50,  // 110: raystack.frontier.v1beta1.AdminService.UpdateWebhook:input_type -> raystack.frontier.v1beta1.UpdateWebhookRequest
	52,  // 111: raystack.frontier.v1beta1.AdminService.DeleteWebhook:input_type -> raystack.frontier.v1beta1.DeleteWebhookRequest
	54,  // 112: raystack.frontier.v1beta1.AdminService.ListWebhooks:input_type -> raystack.frontier.v1beta1.ListWebhooksRequest
	56,  // 113: raystack.frontier.v1beta1.AdminService.UpdateBillingAccountLimits:input_type -> raystack.frontier.v1beta1.UpdateBillingAccountLimitsRequest
	70,  // 114: raystack.frontier.v1beta1.AdminService.CreateProspect:input_type -> raystack.frontier.v1beta1.CreateProspectRequest
	62,  // 115: raystack.frontier.v1beta1.AdminService.ListProspects:input_type -> raystack.frontier.v1beta1.ListProspectsRequest
	64,  // 116: raystack.frontier.v1beta1.AdminService.GetProspect:input_type -> raystack.frontier.v1beta1.GetProspectRequest
	66,  // 117: raystack.frontier.v1beta1.AdminService.UpdateProspect:input_type -> raystack.frontier.v1beta1.UpdateProspectRequest
	68,  // 118: raystack.frontier.v1beta1.AdminService.DeleteProspect:input_type -> raystack.frontier.v1beta1.DeleteProspectRequest
	1,   // 119: raystack.frontier.v1beta1.AdminService.ListAllUsers:output_type -> raystack.frontier.v1beta1.ListAllUsersResponse
	3,   // 120: raystack.frontier.v1beta1.AdminService.ListGroups:output_type -> raystack.frontier.v1beta1.ListGroupsResponse
	5,   // 121: raystack.frontier.v1beta1.AdminService.ListAllOrganizations:output_type -> raystack.frontier.v1beta1.ListAllOrganizationsResponse
	61,  // 122: raystack.frontier.v1beta1.AdminService.SearchOrganizations:output_type -> raystack.frontier.v1beta1.SearchOrganizationsResponse
	73,  // 123: raystack.frontier.v1beta1.AdminService.SearchOrganizationUsers:output_type -> raystack.frontier.v1beta1.SearchOrganizationUsersResponse
	79,  // 124: raystack.frontier.v1beta1.AdminService.SearchProjectUsers:output_type -> raystack.frontier.v1beta1.SearchProjectUsersResponse
	76,  // 125: raystack.frontier.v1beta1.AdminService.SearchOrganizationProjects:output_type -> raystack.frontier.v1beta1.SearchOrganizationProjectsResponse
	81,  // 126: raystack.frontier.v1beta1.AdminService.SearchOrganizationInvoices:output_type -> raystack.frontier.v1beta1.SearchOrganizationInvoicesResponse
	83,  // 127: raystack.frontier.v1beta1.AdminService.SearchOrganizationTokens:output_type -> raystack.frontier.v1beta1.SearchOrganizationTokensResponse
	119, // 128: raystack.frontier.v1beta1.AdminService.ExportOrganizations:output_type -> google.api.HttpBody
	119, // 129: raystack.frontier.v1beta1.AdminService.ExportOrganizationUsers:output_type -> google.api.HttpBody
	119, // 130: raystack.frontier.v1beta1.AdminService.ExportOrganizationProjects:output_type -> google.api.HttpBody
	60,  // 131: raystack.frontier.v1beta1.AdminService.SetOrganizationKyc:output_type -> raystack.frontier.v1beta1.SetOrganizationKycResponse
	7,   // 132: raystack.frontier.v1beta1.AdminService.ListProjects:output_type -> raystack.frontier.v1beta1.ListProjectsResponse
	9,   // 133: raystack.frontier.v1beta1.AdminService.ListRelations:output_type -> raystack.frontier.v1beta1.ListRelationsResponse
	11,  // 134: raystack.frontier.v1beta1.AdminService.ListResources:output_type -> raystack.frontier.v1beta1.ListResourcesResponse
	13,  // 135: raystack.frontier.v1beta1.AdminService.CreateRole:output_type -> raystack.frontier.v1beta1.CreateRoleResponse
	15,  // 136: raystack.frontier.v1beta1.AdminService.UpdateRole:output_type -> raystack.frontier.v1beta1.UpdateRoleResponse
	17,  // 137: raystack.frontier.v1beta1.AdminService.DeleteRole:output_type -> raystack.frontier.v1beta1.DeleteRoleResponse
	20,  // 138: raystack.frontier.v1beta1.AdminService.CreatePermission:output_type -> raystack.frontier.v1beta1.CreatePermissionResponse
	22,  // 139: raystack.frontier.v1beta1.AdminService.UpdatePermission:output_type -> raystack.frontier.v1beta1.UpdatePermissionResponse
	24,  // 140: raystack.frontier.v1beta1.AdminService.DeletePermission:output_type -> raystack.frontier.v1beta1.DeletePermissionResponse
	26,  // 141: raystack.frontier.v1beta1.AdminService.ListPreferences:output_type -> raystack.frontier.v1beta1.ListPreferencesResponse
	28,  // 142: raystack.frontier.v1beta1.AdminService.CreatePreferences:output_type -> raystack.frontier.v1beta1.CreatePreferencesResponse
	30,  // 143: raystack.frontier.v1beta1.AdminService.CheckFederatedResourcePermission:output_type -> raystack.frontier.v1beta1.CheckFederatedResourcePermissionResponse
	32,  // 144: raystack.frontier.v1beta1.AdminService.AddPlatformUser:output_type -> raystack.frontier.v1beta1.AddPlatformUserResponse
	34,  // 145: raystack.frontier.v1beta1.AdminService.ListPlatformUsers:output_type -> raystack.frontier.v1beta1.ListPlatformUsersResponse
	36,  // 146: raystack.frontier.v1beta1.AdminService.RemovePlatformUser:output_type -> raystack.frontier.v1beta1.RemovePlatformUserResponse
	38,  // 147: raystack.frontier.v1beta1.AdminService.DelegatedCheckout:output_type -> raystack.frontier.v1beta1.DelegatedCheckoutResponse
	40,  // 148: raystack.frontier.v1beta1.AdminService.ListAllInvoices:output_type -> raystack.frontier.v1beta1.ListAllInvoicesResponse
	42,  // 149: raystack.frontier.v1beta1.AdminService.GenerateInvoices:output_type -> raystack.frontier.v1beta1.GenerateInvoicesResponse
	44,  // 150: raystack.frontier.v1beta1.AdminService.ListAllBillingAccounts:output_type -> raystack.frontier.v1beta1.ListAllBillingAccountsResponse
	46,  // 151: raystack.frontier.v1beta1.AdminService.RevertBillingUsage:output_type -> raystack.frontier.v1beta1.RevertBillingUsageResponse
	49,  // 152: raystack.frontier.v1beta1.AdminService.CreateWebhook:output_type -> raystack.frontier.v1beta1.CreateWebhookResponse
	51,  // 153: raystack.frontier.v1beta1.AdminService.UpdateWebhook:output_type -> raystack.frontier.v1beta1.UpdateWebhookResponse
	53,  // 154: raystack.frontier.v1beta1.AdminService.DeleteWebhook:output_type -> raystack.frontier.v1beta1.DeleteWebhookResponse
	55,  // 155: raystack.frontier.v1beta1.AdminService.ListWebhooks:output_type -> raystack.frontier.v1beta1.ListWebhooksResponse
	57,  // 156: raystack.frontier.v1beta1.AdminService.UpdateBillingAccountLimits:output_type -> raystack.frontier.v1beta1.UpdateBillingAccountLimitsResponse
	71,  // 157: raystack.frontier.v1beta1.AdminService.CreateProspect:output_type -> raystack.frontier.v1beta1.CreateProspectResponse
	63,  // 158: raystack.frontier.v1beta1.AdminService.ListProspects:output_type -> raystack.frontier.v1beta1.ListProspectsResponse
	65,  // 159: raystack.frontier.v1beta1.AdminService.GetProspect:output_type -> raystack.frontier.v1beta1.GetProspectResponse
	67,  // 160: raystack.frontier.v1beta1.AdminService.UpdateProspect:output_type -> raystack.frontier.v1beta1.UpdateProspectResponse
	69,  // 161: raystack.frontier.v1beta1.AdminService.DeleteProspect:output_type -> raystack.frontier.v1beta1.DeleteProspectResponse
