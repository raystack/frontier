...
func request_FrontierService_AddProjectPrincipal_0(ctx context.Context, marshaler runtime.Marshaler, client FrontierServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AddProjectPrincipalRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.AddProjectPrincipal(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_FrontierService_AddProjectPrincipal_0(ctx context.Context, marshaler runtime.Marshaler, server FrontierServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AddProjectPrincipalRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.AddProjectPrincipal(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterFrontierServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FrontierServiceServer) error {
	...
	mux.Handle("POST", pattern_FrontierService_AddProjectPrincipal_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/raystack.frontier.v1beta1.FrontierService/AddProjectPrincipal", runtime.WithHTTPPathPattern("/v1beta1/projects/{id}/principals"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FrontierService_AddProjectPrincipal_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_FrontierService_AddProjectPrincipal_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterFrontierServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FrontierServiceClient) error {
	...
	mux.Handle("POST", pattern_FrontierService_AddProjectPrincipal_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/raystack.frontier.v1beta1.FrontierService/AddProjectPrincipal", runtime.WithHTTPPathPattern("/v1beta1/projects/{id}/principals"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FrontierService_AddProjectPrincipal_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_FrontierService_AddProjectPrincipal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1beta1", "projects", "id", "principals"}, ""))
...
var (
	...
	forward_FrontierService_AddProjectPrincipal_0 = runtime.ForwardResponseMessage
