...
This works because the generated rules already include the owner and admin permissions. So an
owner or an admin is covered without the action being listed in any role.
