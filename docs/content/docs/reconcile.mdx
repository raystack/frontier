...
Disabled principals are out of scope. A disabled user does not appear in the platform-user
...
principal in the file. Re-enable the user first if you need to reconcile their access.
