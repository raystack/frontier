---
id: admin-service-create-preferences
title: "Create platform preferences"
...
sidebar_label: "Create platform preferences"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Create new platform preferences. The platform preferences **name** must be unique within the platform and can contain only alphanumeric characters, dashes and underscores.",
    "operationId": "AdminService_CreatePreferences",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "Create platform preferences",
        "description":
          {
            "content": "Create new platform preferences. The platform preferences **name** must be unique within the platform and can contain only alphanumeric characters, dashes and underscores.",
            "type": "text/plain",
          },
        "url":
          {
