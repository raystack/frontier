---
id: frontier-service-update-group
title: "Update group"
...
api:
  {
    "operationId": "FrontierService_UpdateGroup",
    "responses":
      {
        "200":
          {
    ...
    "description": "Update group",
    "method": "put",
    "path": "/v1beta1/organizations/{org_id}/groups/{id}",
