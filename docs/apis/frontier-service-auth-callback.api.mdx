---
id: frontier-service-auth-callback
...
api:
  {
    "description": "Callback from a strategy. This is the endpoint where the strategy will redirect the user after successful authentication. This endpoint will be called with the code and state query parameters. The code will be used to get the access token from the strategy and the state will be used to get the return_to url from the session and redirect the user to that url.",
    "operationId": "FrontierService_AuthCallback",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        ...
        {
          "name": "state_options",
          "description": "state_options has additional configurations for the authentication flow at hand\nfor example, in case of passkey, it has challenge and public key",
          "in": "query",
          "required": false,
          "schema": { "type": "object" },
        },
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "strategy_name will not be set for oidc but can be utilized for methods like email magic links",
                      "type": "text/plain",
                    },
                  "key": "strategy_name",
                  "value": "",
                },
                {
                  ...
                  "description":
                    {
                      "content": "for oidc & magic links",
                      "type": "text/plain",
                    },
                  "key": "state",
                  "value": "",
                },
                { "disabled": false, "key": "code", "value": "" },
              ],
            "variable": [],
          },
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Query Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"strategy_name","description":"strategy_name will not be set for oidc but can be utilized for methods like email magic links","in":"query","required":false,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"state","description":"for oidc & magic links","in":"query","required":false,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"code","in":"query","required":false,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"state_options","description":"state_options has additional configurations for the authentication flow at hand\nfor example, in case of passkey, it has challenge and public key","in":"query","required":false,"schema":{"type":"object"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
