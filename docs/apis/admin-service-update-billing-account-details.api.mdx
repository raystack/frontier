---
id: admin-service-update-billing-account-details
title: "Update billing account details"
description: "Update billing account details."
sidebar_label: "Update billing account details"
hide_title: true
...
api:
  {
    ...
    "tags": ["Billing"],
    "method": "put",
    "path": "/v1beta1/admin/organizations/{org_id}/billing/{id}/details",
    ...
    "jsonRequestBodyExample":
      { "credit_min": "string", "due_in_days": "string" },
    "info":
      {
    ...
    "postman":
      {
        "name": "Update billing account details",
        "description":
          {
            "content": "Update billing account details.",
            "type": "text/plain",
          },
        "url":
          {
