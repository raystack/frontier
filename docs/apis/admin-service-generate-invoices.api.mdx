    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Triggers the creation of credit overdraft invoices for all billing accounts.",
            "type": "text/plain",
          },
        "url":
          {
...
Triggers the creation of credit overdraft invoices for all billing accounts.
