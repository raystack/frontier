---
id: frontier-service-list-project-groups
title: "List project groups"
description: "Returns a collection of groups of a project."
sidebar_label: "List project groups"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Returns a collection of groups of a project.",
    "operationId": "FrontierService_ListProjectGroups",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Returns a collection of groups of a project.",
            "type": "text/plain",
          },
        "url":
          {
            "path": ["v1beta1", "projects", ":id", "groups"],
            "host": ["{{baseUrl}}"],
            "query": [{ "disabled": false, "key": "with_roles", "value": "" }],
            "variable":
              [
                {
                  "disabled": false,
