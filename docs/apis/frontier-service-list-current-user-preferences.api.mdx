---
id: frontier-service-list-current-user-preferences
title: "List current user preferences"
description: "List a user preferences by ID."
sidebar_label: "List current user preferences"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "List a user preferences by ID.",
    "operationId": "FrontierService_ListCurrentUserPreferences",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "List current user preferences",
        "description":
