---
id: frontier-service-list-organization-roles
...
sidebar_label: "List organization roles"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Returns a list of custom roles created under an organization with their associated permissions",
    "operationId": "FrontierService_ListOrganizationRoles",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Returns a list of custom roles created under an organization with their associated permissions",
            "type": "text/plain",
          },
        "url":
          {
            ...
            "query":
              [
                { "disabled": false, "key": "state", "value": "" },
                { "disabled": false, "key": "scopes", "value": "" },
              ],
            "variable":
              [
                {
