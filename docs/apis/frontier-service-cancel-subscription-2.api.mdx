---
id: frontier-service-cancel-subscription-2
...
api:
  {
    "description": "Cancel a subscription by ID.",
    "operationId": "FrontierService_CancelSubscription2",
    "responses":
      {
        "200":
          {
    ...
    "tags": ["Subscription"],
    "method": "post",
    "path": "/v1beta1/organizations/{org_id}/billing/subscriptions/{id}/cancel",
    ...
    "jsonRequestBodyExample": { "billing_id": "string", "immediate": true },
    "info":
      {
    ...
    "postman":
      {
        ...
        "description":
          { "content": "Cancel a subscription by ID.", "type": "text/plain" },
        "url":
          {
            "path":
              [
            ...
            "variable":
              [
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the subscription to cancel",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Path Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"org_id","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"id","description":"ID of the subscription to cancel","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><MimeTabs><TabItem label={"application/json"} value={"application/json-schema"}><details style={{}} data-collapsed={false} open={true}><summary style={{"textAlign":"left"}}><strong>Request Body</strong><strong style={{"fontSize":"var(--ifm-code-font-size)","color":"var(--openapi-required)"}}> required</strong></summary><div style={{"textAlign":"left","marginLeft":"1rem"}}></div><ul style={{"marginLeft":"1rem"}}><SchemaItem collapsible={false} name={"billing_id"} required={false} schemaName={"ID of the billing account to update the subscription for"} qualifierMessage={undefined} schema={{"type":"string","title":"ID of the billing account to update the subscription for"}}></SchemaItem><SchemaItem collapsible={false} name={"immediate"} required={false} schemaName={"boolean"} qualifierMessage={undefined} schema={{"type":"boolean"}}></SchemaItem></ul></details></TabItem></MimeTabs><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
