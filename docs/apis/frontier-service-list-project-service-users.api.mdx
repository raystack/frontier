---
id: frontier-service-list-project-service-users
title: "List project serviceusers"
description: "Returns a collection of users of a project."
sidebar_label: "List project serviceusers"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Returns a collection of users of a project.",
    "operationId": "FrontierService_ListProjectServiceUsers",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "List project serviceusers",
        "description":
          {
            "content": "Returns a collection of users of a project.",
            "type": "text/plain",
          },
        "url":
          {
