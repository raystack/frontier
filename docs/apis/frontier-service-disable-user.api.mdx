---
id: frontier-service-disable-user
title: "Disable user"
...
api:
  {
    "description": "Sets the state of the user as diabled.The user's membership to groups and organizations will still exist along with all it's roles for access control, but the user will not be able to log in and access the Frontier instance.",
    "operationId": "FrontierService_DisableUser",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Sets the state of the user as diabled.The user's membership to groups and organizations will still exist along with all it's roles for access control, but the user will not be able to log in and access the Frontier instance.",
            "type": "text/plain",
          },
        "url":
          {
