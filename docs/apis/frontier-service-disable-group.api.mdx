---
id: frontier-service-disable-group
title: "Disable group"
...
sidebar_label: "Disable group"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Sets the state of the group as disabled. The group will not be available for access control and the existing users in the group will not be able to access any resources that are assigned to the group. No other users can be added to the group while it is disabled.",
    "operationId": "FrontierService_DisableGroup",
    "responses":
      {
        "200":
          {
    ...
    "tags": ["Group"],
    "method": "post",
    "path": "/v1beta1/organizations/{org_id}/groups/{id}/disable",
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Sets the state of the group as disabled. The group will not be available for access control and the existing users in the group will not be able to access any resources that are assigned to the group. No other users can be added to the group while it is disabled.",
            "type": "text/plain",
          },
        "url":
          {
