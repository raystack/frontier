    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/odpf/shield',
      ...
      announcementBar: {
        id: 'star-repo',
        content: '⭐️ If you like Shield, give it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/odpf/shield">GitHub</a>! ⭐',
        backgroundColor: '#222',
        textColor: '#eee',
        isCloseable: true,
      },
