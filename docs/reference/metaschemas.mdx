...
<Tabs defaultValue="User MetaSchema">
  <Tabs.List>
    <Tabs.Trigger value="User MetaSchema">User MetaSchema</Tabs.Trigger>
    <Tabs.Trigger value="Valid User">Valid User</Tabs.Trigger>
  </Tabs.List>
  <Tabs.Content value="User MetaSchema">
