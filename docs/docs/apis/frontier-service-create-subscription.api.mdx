---
id: frontier-service-create-subscription
...
api:
  {
    "description": "Create a new subscription for a billing customer.",
    "operationId": "FrontierService_CreateSubscription",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        {
          "name": "customerId",
          "description": "ID of the billing customer to create the subscription for",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["Subscription"],
    "method": "post",
    "path": "/v1beta1/billing/customers/{customerId}/subscriptions",
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Create a new subscription for a billing customer.",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing customer to create the subscription for",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
