---
id: shield-service-list-meta-schemas
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Returns a list of all metaschemas configured on an instance level in Shield. e.g user, project, organization etc",
            "type": "text/plain",
          },
        "url":
          {
