...
api:
  {
    ...
    "parameters":
      [
        {
          "name": "customerId",
          "description": "ID of the billing customer to update the subscription for",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["Subscription"],
    "method": "put",
    "path": "/v1beta1/billing/customers/{customerId}/subscriptions/{id}",
    ...
    "jsonRequestBodyExample": { "body": { "planId": "string" } },
    "info":
      {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing customer to update the subscription for",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
