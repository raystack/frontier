...
api:
  {
    ...
    "tags": ["Subscription"],
    "method": "put",
    "path": "/v1beta1/billing/{billingId}/subscriptions/{id}",
    ...
    "postman":
      {
        ...
        "url":
          {
            "path":
              ["v1beta1", "billing", ":billingId", "subscriptions", ":id"],
            "host": ["{{baseUrl}}"],
            "query": [],
            "variable":
              [
