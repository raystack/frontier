---
id: frontier-service-update-billing-customer
title: "Update billing customer"
description: "Update a billing customer by ID."
sidebar_label: "Update billing customer"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Update a billing customer by ID.",
    "operationId": "FrontierService_UpdateBillingCustomer",
    "responses":
      {
        "200":
          {
                        ...
                        "properties":
                          {
                            "billingCustomer":
                              {
                                "title": "Updated billing customer",
                                "type": "object",
                                "properties":
                                  {
                                    "id": { "type": "string" },
    ...
    "parameters":
      [
        {
          "name": "id",
          "description": "ID of the billing customer to update",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
                    ...
                    "properties":
                      {
                        ...
                        "body":
                          {
                            "description": "Billing customer to update.",
                            "type": "object",
                            "properties":
                              {
                                "name": { "type": "string" },
    ...
    "tags": ["Billing"],
    "method": "put",
    "path": "/v1beta1/billing/customers/{id}",
    ...
    "postman":
      {
        "name": "Update billing customer",
        "description":
          {
            "content": "Update a billing customer by ID.",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing customer to update",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
