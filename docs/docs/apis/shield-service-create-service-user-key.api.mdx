...
title: "Create a service user key"
...
sidebar_label: "Create a service user key"
hide_title: true
...
api:
  {
    ...
    "postman":
      {
        "name": "Create a service user key",
        "description":
          {
