...
api:
  {
    ...
    "tags": ["Organization"],
    "method": "get",
    "path": "/v1beta1/organizations/{org_id}/invitations/{id}",
    ...
    "postman":
      {
        "name": "Get pending invitation",
        "description":
          {
            "content": "Returns a pending invitation queued for an organization",
            "type": "text/plain",
          },
        "url":
          {
            "path":
              ["v1beta1", "organizations", ":org_id", "invitations", ":id"],
            "host": ["{{baseUrl}}"],
            "query": [],
            "variable":
              [
