---
id: frontier-service-create-organization-preferences
title: "Create organization preferences"
...
sidebar_label: "Create organization preferences"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Create a new organization preferences. The organization preferences **name** must be unique within the organization and can contain only alphanumeric characters, dashes and underscores.",
    "operationId": "FrontierService_CreateOrganizationPreferences",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "Create organization preferences",
        "description":
          {
            "content": "Create a new organization preferences. The organization preferences **name** must be unique within the organization and can contain only alphanumeric characters, dashes and underscores.",
            "type": "text/plain",
          },
        "url":
          {
