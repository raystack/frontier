...
>
  ...
  <span>
    ...
    <a href={"mailto:hello@raystack.org"}>hello@raystack.org</a>
  </span>
  <span>
    URL: <a href={"https://www.raystack.org/"}>https://www.raystack.org/</a>
  </span>
</div>
<div style={{ marginBottom: "var(--ifm-paragraph-margin-bottom)" }}>
  <h3 style={{ marginBottom: "0.25rem" }}>License</h3>
  <a href={"https://github.com/raystack/shield/blob/main/LICENSE"}>
    Apache 2.0
  </a>
</div>
