...
api:
  {
    ...
    "jsonRequestBodyExample":
      { "redirect": true, "returnTo": "string", "email": "string" },
    "info":
      {
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Path Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"strategyName","description":"Name of the strategy to use for authentication.<br/> *Example:* `google`","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><MimeTabs><TabItem label={"application/json"} value={"application/json-schema"}><details style={{}} data-collapsed={false} open={true}><summary style={{"textAlign":"left"}}><strong>Request Body</strong><strong style={{"fontSize":"var(--ifm-code-font-size)","color":"var(--openapi-required)"}}> required</strong></summary><div style={{"textAlign":"left","marginLeft":"1rem"}}></div><ul style={{"marginLeft":"1rem"}}><SchemaItem collapsible={false} name={"redirect"} required={false} schemaName={"by default, location redirect header for starting authentication flow if applicable\nwill be skipped unless this is set to true, useful in browser"} qualifierMessage={undefined} schema={{"type":"boolean","description":"If set to true, location header will be set for redirect","title":"by default, location redirect header for starting authentication flow if applicable\nwill be skipped unless this is set to true, useful in browser"}}></SchemaItem><SchemaItem collapsible={false} name={"returnTo"} required={false} schemaName={"by default, after successful authentication no operation will be performed\nto apply redirection in case of browsers, provide a url that will be used\nfor redirection after authentication"} qualifierMessage={undefined} schema={{"type":"string","description":"URL to redirect after successful authentication.<br/> *Example:*`\"https://frontier.example.com\"`","title":"by default, after successful authentication no operation will be performed\nto apply redirection in case of browsers, provide a url that will be used\nfor redirection after authentication"}}></SchemaItem><SchemaItem collapsible={false} name={"email"} required={false} schemaName={"email of the user for magic links"} qualifierMessage={undefined} schema={{"type":"string","description":"Email of the user to authenticate. Used for magic links.<br/> *Example:*`example@acme.org`","title":"email of the user for magic links"}}></SchemaItem></ul></details></TabItem></MimeTabs><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
