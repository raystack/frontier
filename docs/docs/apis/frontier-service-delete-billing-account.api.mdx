---
id: frontier-service-delete-billing-account
title: "Delete billing account"
description: "Delete a billing account by ID."
sidebar_label: "Delete billing account"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Delete a billing account by ID.",
    "operationId": "FrontierService_DeleteBillingAccount",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        ...
        {
          "name": "id",
          "description": "ID of the billing account to delete",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Delete a billing account by ID.",
            "type": "text/plain",
          },
        "url":
          {
            ...
            "variable":
              [
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing account to delete",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
