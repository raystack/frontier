---
id: frontier-service-delete-service-user-credential
title: "Delete service user credentials"
description: "Delete a service user credential."
sidebar_label: "Delete service user credentials"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Delete a service user credential.",
    "operationId": "FrontierService_DeleteServiceUserCredential",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        ...
        {
          "name": "id",
          "description": "The unique ID of the service user to delete a secret for.",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
        {
          "name": "secret_id",
          "description": "The unique ID of the secret to delete.",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["ServiceUser"],
    "method": "delete",
    "path": "/v1beta1/organizations/{org_id}/serviceusers/{id}/secrets/{secret_id}",
    ...
    "postman":
      {
        "name": "Delete service user credentials",
        "description":
          {
            "content": "Delete a service user credential.",
            "type": "text/plain",
          },
        "url":
          {
            ...
            "variable":
              [
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The unique ID of the service user to delete a secret for.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The unique ID of the secret to delete.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
...
Delete a service user credential.

<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Path Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"org_id","description":"The organization ID to which the service user belongs to.","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"id","description":"The unique ID of the service user to delete a secret for.","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"secret_id","description":"The unique ID of the secret to delete.","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
