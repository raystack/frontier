...
api:
  {
    ...
    "parameters":
      [
        ...
        {
          "name": "withMemberPermissions",
          "description": "list of permissions needs to be checked against each member \nof the group as principal and group as subject",
          "in": "query",
          "required": false,
          "explode": true,
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "list of permissions needs to be checked against each member \nof the group as principal and group as subject",
                      "type": "text/plain",
                    },
                  "key": "withMemberPermissions",
                  "value": "",
                },
              ],
            "variable":
