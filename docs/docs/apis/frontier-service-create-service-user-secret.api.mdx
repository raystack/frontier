---
id: frontier-service-create-service-user-secret
title: "Create service user client/secret"
...
sidebar_label: "Create service user client/secret"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Generate a service user secret and return it. The secret value will not be persisted and should be securely stored by client.",
    "operationId": "FrontierService_CreateServiceUserSecret",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "Create service user client/secret",
        "description":
          {
            "content": "Generate a service user secret and return it. The secret value will not be persisted and should be securely stored by client.",
            "type": "text/plain",
          },
        "url":
          {
...
## Create service user client/secret
