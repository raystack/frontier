---
id: admin-service-get-billing-account-details
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Get billing account details that can be updated.",
            "type": "text/plain",
          },
        "url":
          {
...
Get billing account details that can be updated.
