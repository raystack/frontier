---
id: frontier-service-delete-billing-customer
title: "Delete billing customer"
description: "Delete a billing customer by ID."
sidebar_label: "Delete billing customer"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Delete a billing customer by ID.",
    "operationId": "FrontierService_DeleteBillingCustomer",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        {
          "name": "id",
          "description": "ID of the billing customer to delete",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "postman":
      {
        "name": "Delete billing customer",
        "description":
          {
            "content": "Delete a billing customer by ID.",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing customer to delete",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
