---
id: frontier-service-list-organization-preferences
title: "List organization preferences"
description: "List an organization preferences by ID."
sidebar_label: "List organization preferences"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "List an organization preferences by ID.",
    "operationId": "FrontierService_ListOrganizationPreferences",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "List organization preferences",
        "description":
          {
            "content": "List an organization preferences by ID.",
            "type": "text/plain",
          },
        "url":
          {
