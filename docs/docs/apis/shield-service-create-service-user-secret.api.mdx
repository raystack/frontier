...
title: "Create a service user secret"
...
sidebar_label: "Create a service user secret"
hide_title: true
...
api:
  {
    ...
    "postman":
      {
        "name": "Create a service user secret",
        "description":
          {
