---
id: admin-service-list-all-billing-accounts
title: "List all billing accounts"
...
sidebar_label: "List all billing accounts"
hide_title: true
...
api:
  {
    ...
    "postman":
      {
        "name": "List all billing accounts",
        "description":
          {
            "content": "Lists all the billing accounts from all the organizations in a Frontier instance. It can be filtered by organization.",
            "type": "text/plain",
          },
        "url":
          {
