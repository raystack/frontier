---
id: admin-service-list-relations
title: "List all relations"
description: "List all relations"
sidebar_label: "List all relations"
hide_title: true
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "The subject to filter by.",
                      "type": "text/plain",
                    },
                  "key": "subject",
                  "value": "",
                },
                {
                  ...
                  "description":
                    {
                      "content": "The object to filter by.",
                      "type": "text/plain",
                    },
                  "key": "object",
                  "value": "",
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Query Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"subject","description":"The subject to filter by.","in":"query","required":false,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"object","description":"The object to filter by.","in":"query","required":false,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
