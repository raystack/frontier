---
id: frontier-service-list-project-admins
title: "List project admins"
description: "Returns a collection of admins of a project"
sidebar_label: "List project admins"
hide_title: true
...
api:
  {
    ...
    "postman":
      {
        "name": "List project admins",
        "description":
          {
            "content": "Returns a collection of admins of a project",
            "type": "text/plain",
          },
        "url":
          {
