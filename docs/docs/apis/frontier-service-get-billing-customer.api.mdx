---
id: frontier-service-get-billing-customer
title: "Get billing customer"
description: "Get a billing customer by ID."
sidebar_label: "Get billing customer"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Get a billing customer by ID.",
    "operationId": "FrontierService_GetBillingCustomer",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        {
          "name": "id",
          "description": "ID of the billing customer to get",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "postman":
      {
        "name": "Get billing customer",
        "description":
          { "content": "Get a billing customer by ID.", "type": "text/plain" },
        "url":
          {
            "path": ["v1beta1", "billing", "customers", ":id"],
            "host": ["{{baseUrl}}"],
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing customer to get",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
