---
id: shield-service-list-service-user-keys
...
api:
  {
    "description": "List all the keys of a service user with its details except jwk.",
    "operationId": "ShieldService_ListServiceUserKeys",
    "responses":
      {
        "200":
          {
