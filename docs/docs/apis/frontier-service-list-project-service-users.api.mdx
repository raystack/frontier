        ...
        "url":
          {
            "path": ["v1beta1", "projects", ":id", "serviceusers"],
            "host": ["{{baseUrl}}"],
            "query": [{ "disabled": false, "key": "withRoles", "value": "" }],
            "variable":
              [
                {
                  "disabled": false,
