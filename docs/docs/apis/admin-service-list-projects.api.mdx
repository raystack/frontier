---
id: admin-service-list-projects
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Lists all the projects from all the organizations in a Frontier instance. It can be filtered by organization and state.",
            "type": "text/plain",
          },
        "url":
          {
