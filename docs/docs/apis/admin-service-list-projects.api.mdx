    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Lists all the projects from all the organizations in a Shield instance. It can be filtered by organization and state.",
            "type": "text/plain",
          },
        "url":
          {
