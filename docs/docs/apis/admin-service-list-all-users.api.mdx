---
id: admin-service-list-all-users
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Lists all the users from all the organizations in a Frontier instance. It can be filtered by keyword, organization, group and state.",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "The maximum number of users to return per page. The default is 50.",
                      "type": "text/plain",
                    },
                  "key": "page_size",
                  "value": "",
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "The keyword to search for. It can be a user's name, email,metadata or id.",
                      "type": "text/plain",
                    },
                  "key": "keyword",
                  "value": "",
