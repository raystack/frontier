---
id: frontier-service-create-group-preferences
title: "Create group preferences"
...
sidebar_label: "Create group preferences"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Create a new group preferences. The group preferences **name** must be unique within the group and can contain only alphanumeric characters, dashes and underscores.",
    "operationId": "FrontierService_CreateGroupPreferences",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "Create group preferences",
        "description":
          {
            "content": "Create a new group preferences. The group preferences **name** must be unique within the group and can contain only alphanumeric characters, dashes and underscores.",
            "type": "text/plain",
          },
        "url":
          {
