---
id: frontier-service-list-group-admins
title: "List group admins"
description: "Returns a collection of admins of a group"
sidebar_label: "List group admins"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Returns a collection of admins of a group",
    "operationId": "FrontierService_ListGroupAdmins",
    "responses":
      {
        "200":
          {
    ...
    "tags": ["Group"],
    "method": "get",
    "path": "/v1beta1/organizations/{orgId}/groups/{id}/admins",
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Returns a collection of admins of a group",
            "type": "text/plain",
          },
        "url":
          {
            "path":
              ["v1beta1", "organizations", ":orgId", "groups", ":id", "admins"],
            "host": ["{{baseUrl}}"],
            "query": [],
            "variable":
              [
...
Returns a collection of admins of a group
