---
id: frontier-service-list-service-user-jw-ks
title: "List service user keys"
description: "List all the keys of a service user with its details except jwk."
sidebar_label: "List service user keys"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "List all the keys of a service user with its details except jwk.",
    "operationId": "FrontierService_ListServiceUserJWKs",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        ...
        {
          "name": "id",
          "description": "The unique ID of the service user to list keys for.",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "postman":
      {
        "name": "List service user keys",
        "description":
          {
            "content": "List all the keys of a service user with its details except jwk.",
            "type": "text/plain",
          },
        "url":
          {
            ...
            "variable":
              [
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The unique ID of the service user to list keys for.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
