---
id: frontier-service-cancel-subscription
...
api:
  {
    "description": "Cancel a subscription by ID.",
    "operationId": "FrontierService_CancelSubscription",
    "responses":
      {
        "200":
          {
    ...
    "tags": ["Subscription"],
    "method": "post",
    "path": "/v1beta1/organizations/{org_id}/billing/{billing_id}/subscriptions/{id}/cancel",
    ...
    "jsonRequestBodyExample": { "immediate": true },
    "info":
      {
