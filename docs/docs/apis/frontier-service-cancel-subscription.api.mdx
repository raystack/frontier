...
api:
  {
    ...
    "parameters":
      [
        {
          "name": "billingId",
          "description": "ID of the billing account to cancel the subscription for",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["Subscription"],
    "method": "post",
    "path": "/v1beta1/billing/{billingId}/subscriptions/{id}/cancel",
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing account to cancel the subscription for",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Path Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"billingId","description":"ID of the billing account to cancel the subscription for","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"id","description":"ID of the subscription to cancel","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
