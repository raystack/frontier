        ...
        "url":
          {
            ...
            "host": ["{{baseUrl}}"],
            "query": [{ "disabled": false, "key": "immediate", "value": "" }],
            "variable":
              [
                {
                  "disabled": false,
