                    ...
                    "properties":
                      {
                        "orgId":
                          {
                            "type": "string",
                            "title": "ID of the organization to create the billing account for",
                          },
                        "body":
                          {
