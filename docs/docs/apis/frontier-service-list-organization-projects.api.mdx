---
id: frontier-service-list-organization-projects
title: "Get organization projects"
description: "Get all projects that belong to an organization"
sidebar_label: "Get organization projects"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Get all projects that belong to an organization",
    "operationId": "FrontierService_ListOrganizationProjects",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        ...
        {
          "name": "state",
          "description": "Filter projects by state. If not specified, all projects are returned. <br/> *Possible values:* `enabled` or `disabled`",
          "in": "query",
          "required": false,
          "schema": { "type": "string" },
        },
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Get all projects that belong to an organization",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "Filter projects by state. If not specified, all projects are returned. <br/> *Possible values:* `enabled` or `disabled`",
                      "type": "text/plain",
                    },
                  "key": "state",
                  "value": "",
