---
id: frontier-service-list-organization-groups
...
sidebar_label: "List organization groups"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Get all groups that belong to an organization. The results can be filtered by state which can be either be enabled or disabled.",
    "operationId": "FrontierService_ListOrganizationGroups",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        ...
        {
          "name": "state",
          "description": "The state of the group to filter by. It can be enabled or disabled.",
          "in": "query",
          "required": false,
          "schema": { "type": "string" },
        },
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Get all groups that belong to an organization. The results can be filtered by state which can be either be enabled or disabled.",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "The state of the group to filter by. It can be enabled or disabled.",
                      "type": "text/plain",
                    },
                  "key": "state",
                  "value": "",
                },
                { "disabled": false, "key": "group_ids", "value": "" },
                { "disabled": false, "key": "with_members", "value": "" },
