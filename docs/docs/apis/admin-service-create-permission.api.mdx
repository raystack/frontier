    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Creates a permission. It can be used to grant permissions to all the resources in a Shield instance.",
            "type": "text/plain",
          },
        "url":
          {
