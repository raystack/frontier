---
id: shield-service-list-service-users
title: "List service users of an organization"
...
sidebar_label: "List service users of an organization"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Returns the users from all the organizations in a Shield instance. It can be filtered by keyword, organization, group and state. Additionally you can include page number and page size for pagination.",
    "operationId": "ShieldService_ListServiceUsers",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "List service users of an organization",
        "description":
          {
