---
id: frontier-service-delete-organization
...
api:
  {
    "description": "Delete an organization and all of its relations permanently. The organization users will not be deleted from Frontier.",
    "operationId": "FrontierService_DeleteOrganization",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Delete an organization and all of its relations permanently. The organization users will not be deleted from Frontier.",
            "type": "text/plain",
          },
        "url":
          {
