    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Lists all the groups from all the organizations in a Shield instance. It can be filtered by organization and state.",
            "type": "text/plain",
          },
        "url":
          {
