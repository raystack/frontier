...
api:
  {
    ...
    "tags": ["Policy"],
    "method": "post",
    "path": "/v1beta1/policies/{id}/replace",
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Deletes an existing policy and create new.",
            "type": "text/plain",
          },
        "url":
          {
