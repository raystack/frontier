...
api:
  {
    ...
    "parameters":
      [
        ...
        {
          "name": "verified",
          "description": "filter to list only verified domains. If not provided, all domains for an org will be listed",
          "in": "query",
          "required": false,
          "schema": { "type": "boolean" },
        },
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "filter to list only verified domains. If not provided, all domains for an org will be listed",
                      "type": "text/plain",
                    },
                  "key": "verified",
                  "value": "",
