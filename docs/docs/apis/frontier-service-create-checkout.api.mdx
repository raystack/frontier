...
api:
  {
    ...
    "parameters":
      [
        {
          "name": "billingId",
          "description": "ID of the billing account to create the subscription for",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["Checkout"],
    "method": "post",
    "path": "/v1beta1/billing/{billingId}/checkouts",
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing account to create the subscription for",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
