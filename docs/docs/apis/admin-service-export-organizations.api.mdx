---
id: admin-service-export-organizations
...
api:
  {
    "description": "Export organization with demographic properties and billing plan details",
    "operationId": "AdminService_ExportOrganizations",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Export organization with demographic properties and billing plan details",
            "type": "text/plain",
          },
        "url":
          {
...
Export organization with demographic properties and billing plan details
