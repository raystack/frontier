---
id: admin-service-remove-platform-user
title: "Remove platform user"
description: "Removes a user from the platform."
sidebar_label: "Remove platform user"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Removes a user from the platform.",
    "operationId": "AdminService_RemovePlatformUser",
    "responses":
      {
        "200":
          {
                    ...
                    "properties":
                      {
                        "user_id":
                          {
                            "type": "string",
                            "description": "The user id to remove from the the platform.",
                          },
                        "serviceuser_id":
                          {
                            "type": "string",
                            "description": "The service user id to remove from the the platform.",
                          },
                      },
                  },
              },
    ...
    "jsonRequestBodyExample":
      { "user_id": "string", "serviceuser_id": "string" },
    "info":
      {
    ...
    "postman":
      {
        "name": "Remove platform user",
        "description":
          {
            "content": "Removes a user from the platform.",
            "type": "text/plain",
          },
        "url":
          {
