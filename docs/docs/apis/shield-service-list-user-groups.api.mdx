...
api:
  {
    ...
    "postman":
      {
        "name": "List Groups of a User",
        "description":
          {
            "content": "Lists all the groups a user belongs to across all organization in Shield.",
            "type": "text/plain",
          },
        "url":
          {
            "path": ["v1beta1", "users", ":id", "groups"],
            "host": ["{{baseUrl}}"],
            "query": [{ "disabled": false, "key": "role", "value": "" }],
            "variable":
              [
                {
                  "disabled": false,
