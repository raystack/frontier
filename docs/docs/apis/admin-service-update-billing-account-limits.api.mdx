---
id: admin-service-update-billing-account-limits
title: "Update billing account limits"
description: "Update billing account limits."
sidebar_label: "Update billing account limits"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Update billing account limits.",
    "operationId": "AdminService_UpdateBillingAccountLimits",
    "responses":
      {
        "200":
          {
    ...
    "deprecated": true,
    "method": "put",
    "path": "/v1beta1/admin/organizations/{org_id}/billing/{id}/limits",
    ...
    "jsonRequestBodyExample": { "credit_min": "string" },
    "info":
      {
    ...
    "postman":
      {
        "name": "Update billing account limits",
        "description":
          { "content": "Update billing account limits.", "type": "text/plain" },
        "url":
          {
            "path":
              [
