---
id: shield-service-add-organization-users
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Add a user to an organization. A user must exists in Shield before adding it to an org. This request will fail if the user doesn't exists",
            "type": "text/plain",
          },
        "url":
          {
