---
id: frontier-service-create-current-user-preferences
title: "Create current user preferences"
...
sidebar_label: "Create current user preferences"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Create a new user preferences. The user preferences **name** must be unique within the user and can contain only alphanumeric characters, dashes and underscores.",
    "operationId": "FrontierService_CreateCurrentUserPreferences",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "Create current user preferences",
        "description":
          {
            "content": "Create a new user preferences. The user preferences **name** must be unique within the user and can contain only alphanumeric characters, dashes and underscores.",
            "type": "text/plain",
          },
        "url":
          {
