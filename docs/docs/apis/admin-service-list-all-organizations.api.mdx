    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Lists all the organizations in a Shield instance. It can be filtered by user and state.",
            "type": "text/plain",
          },
        "url":
          {
