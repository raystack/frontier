---
id: frontier-service-delete-service-user-secret
title: "Delete service user secret"
description: "Delete a service user secret credential."
sidebar_label: "Delete service user secret"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Delete a service user secret credential.",
    "operationId": "FrontierService_DeleteServiceUserSecret",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "Delete service user secret",
        "description":
          {
            "content": "Delete a service user secret credential.",
            "type": "text/plain",
          },
        "url":
          {
