---
id: frontier-service-get-billing-balance
title: "Get billing balance"
description: "Get the balance of a billing account by ID."
sidebar_label: "Get billing balance"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Get the balance of a billing account by ID.",
    "operationId": "FrontierService_GetBillingBalance",
    "responses":
      {
        "200":
          {
                        ...
                        "properties":
                          {
                            "balance":
                              {
                                "title": "Balance of the billing account",
                                "type": "object",
                                "properties":
                                  {
                                    "amount":
    ...
    "parameters":
      [
        ...
        {
          "name": "id",
          "description": "ID of the billing account to get the balance for",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["Billing"],
    "method": "get",
    "path": "/v1beta1/organizations/{org_id}/billing/{id}/balance",
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Get the balance of a billing account by ID.",
            "type": "text/plain",
          },
        "url":
          {
            ...
            "variable":
              [
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing account to get the balance for",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
