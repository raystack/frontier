---
id: frontier-service-delete-service-user-token
title: "Delete service user token"
description: "Delete a service user token."
sidebar_label: "Delete service user token"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Delete a service user token.",
    "operationId": "FrontierService_DeleteServiceUserToken",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        ...
        {
          "name": "id",
          "description": "The unique ID of the service user to delete a token for.",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["ServiceUser"],
    "method": "delete",
    "path": "/v1beta1/organizations/{org_id}/serviceusers/{id}/tokens/{token_id}",
    ...
    "postman":
      {
        "name": "Delete service user token",
        "description":
          { "content": "Delete a service user token.", "type": "text/plain" },
        "url":
          {
            "path":
              [
            ...
            "variable":
              [
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The unique ID of the service user to delete a token for.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The unique ID of the token to delete.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
...
## Delete service user token

Delete a service user token.

<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Path Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"org_id","description":"The organization ID to which the service user belongs to.","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"id","description":"The unique ID of the service user to delete a token for.","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"token_id","description":"The unique ID of the token to delete.","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
