---
id: admin-service-list-preferences
title: "List platform preferences"
description: "Returns a list of all preferences configured on an instance in Frontier. e.g user, project, organization etc"
sidebar_label: "List platform preferences"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Returns a list of all preferences configured on an instance in Frontier. e.g user, project, organization etc",
    "operationId": "AdminService_ListPreferences",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "List platform preferences",
        "description":
          {
            "content": "Returns a list of all preferences configured on an instance in Frontier. e.g user, project, organization etc",
            "type": "text/plain",
          },
        "url":
          {
