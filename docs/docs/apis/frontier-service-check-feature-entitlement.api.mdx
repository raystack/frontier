...
api:
  {
    ...
    "jsonRequestBodyExample": { "customerId": "string", "feature": "string" },
    "info":
      {
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Check if a billing customer is entitled to a feature.",
            "type": "text/plain",
          },
        "url":
          {
