...
api:
  {
    ...
    "tags": ["Entitlement"],
    "method": "post",
    "path": "/v1beta1/billing/{billingId}/check",
    ...
    "jsonRequestBodyExample": { "feature": "string" },
    "info":
      {
