        ...
        "url":
          {
            "path": ["v1beta1", "organizations", ":orgId", "invitations"],
            "host": ["{{baseUrl}}"],
            "query": [{ "disabled": false, "key": "userId", "value": "" }],
            "variable":
              [
                {
                  "disabled": false,
