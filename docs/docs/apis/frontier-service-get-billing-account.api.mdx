        ...
        "url":
          {
            ...
            "host": ["{{baseUrl}}"],
            "query":
              [{ "disabled": false, "key": "withPaymentMethods", "value": "" }],
            "variable":
              [
                {
                  "disabled": false,
