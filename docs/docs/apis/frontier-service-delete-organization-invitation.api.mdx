...
api:
  {
    ...
    "postman":
      {
        "name": "Delete pending invitation",
        "description":
          {
            "content": "Delete a pending invitation queued for an organization",
            "type": "text/plain",
          },
        "url":
          {
