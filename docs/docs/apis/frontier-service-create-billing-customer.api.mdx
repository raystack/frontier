---
id: frontier-service-create-billing-customer
title: "Create billing customer"
description: "Create a new billing customer for an organization."
sidebar_label: "Create billing customer"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Create a new billing customer for an organization.",
    "operationId": "FrontierService_CreateBillingCustomer",
    "responses":
      {
        "200":
          {
                        ...
                        "properties":
                          {
                            "billingCustomer":
                              {
                                "title": "Created billing customer",
                                "type": "object",
                                "properties":
                                  {
                                    "id": { "type": "string" },
                    ...
                    "properties":
                      {
                        "orgId":
                          {
                            "type": "string",
                            "title": "ID of the organization to create the billing customer for",
                          },
                        "body":
                          {
                            "description": "Billing customer to create.",
                            "type": "object",
                            "properties":
                              {
                                "name": { "type": "string" },
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Create a new billing customer for an organization.",
            "type": "text/plain",
          },
        "url":
          {
