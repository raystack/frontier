---
id: frontier-service-enable-group
title: "Enable group"
...
sidebar_label: "Enable group"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Sets the state of the group as enabled. The `enabled` flag is used to determine if the group can be used for access control.",
    "operationId": "FrontierService_EnableGroup",
    "responses":
      {
        "200":
          {
    ...
    "tags": ["Group"],
    "method": "post",
    "path": "/v1beta1/organizations/{org_id}/groups/{id}/enable",
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Sets the state of the group as enabled. The `enabled` flag is used to determine if the group can be used for access control.",
            "type": "text/plain",
          },
        "url":
          {
