---
id: shield-service-disable-user
title: "Disable user"
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Sets the state of the user as diabled.The user's membership to groups and organizations will still exist along with all it's roles for access control, but the user will not be able to log in and access the Shield instance.",
            "type": "text/plain",
          },
        "url":
          {
