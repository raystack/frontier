---
id: frontier-service-disable-billing-account
title: "Disable billing account"
...
sidebar_label: "Disable billing account"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Disable a billing account by ID. Disabling a billing account doesn't automatically disable it's active subscriptions.",
    "operationId": "FrontierService_DisableBillingAccount",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        ...
        {
          "name": "id",
          "description": "ID of the billing account to disable",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["Billing"],
    "method": "post",
    "path": "/v1beta1/organizations/{org_id}/billing/{id}/disable",
    ...
    "postman":
      {
        "name": "Disable billing account",
        "description":
          {
            "content": "Disable a billing account by ID. Disabling a billing account doesn't automatically disable it's active subscriptions.",
            "type": "text/plain",
          },
        "url":
          {
            ...
            "variable":
              [
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing account to disable",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
