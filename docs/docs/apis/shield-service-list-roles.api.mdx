...
description: "Returns a list of Shield predefined roles with their associated permissions"
sidebar_label: "List default roles"
hide_title: true
...
api:
  {
    ...
    "postman":
      {
        "name": "List default roles",
        "description":
          {
            "content": "Returns a list of Shield predefined roles with their associated permissions",
            "type": "text/plain",
          },
        "url":
          {
