...
api:
  {
    ...
    "parameters":
      [
        {
          "name": "userId",
          "description": "The user ID to filter by. It can be used to list all the organizations that the user is a member of. Otherwise, all the organizations in the Shield instance will be listed.",
          "in": "query",
          "required": false,
          "schema": { "type": "string" },
        },
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "The user ID to filter by. It can be used to list all the organizations that the user is a member of. Otherwise, all the organizations in the Shield instance will be listed.",
                      "type": "text/plain",
                    },
                  "key": "userId",
                  "value": "",
