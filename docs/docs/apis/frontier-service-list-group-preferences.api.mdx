---
id: frontier-service-list-group-preferences
title: "List group preferences"
description: "List a group preferences by ID."
sidebar_label: "List group preferences"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "List a group preferences by ID.",
    "operationId": "FrontierService_ListGroupPreferences",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        "name": "List group preferences",
        "description":
          {
            "content": "List a group preferences by ID.",
            "type": "text/plain",
          },
        "url":
          {
