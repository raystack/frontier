---
id: frontier-service-delete-service-user-jwk
title: "Delete service user key"
description: "Delete a service user key permanently."
sidebar_label: "Delete service user key"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Delete a service user key permanently.",
    "operationId": "FrontierService_DeleteServiceUserJWK",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        ...
        {
          "name": "id",
          "description": "The unique ID of the service user to delete a key for.",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "postman":
      {
        "name": "Delete service user key",
        "description":
          {
            "content": "Delete a service user key permanently.",
            "type": "text/plain",
          },
        "url":
          {
            ...
            "variable":
              [
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The unique ID of the service user to delete a key for.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The unique ID of the key to delete.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Path Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"org_id","description":"The organization ID to which the service user belongs to.","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"id","description":"The unique ID of the service user to delete a key for.","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"key_id","description":"The unique ID of the key to delete.","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
