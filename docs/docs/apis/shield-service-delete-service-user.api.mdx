---
id: shield-service-delete-service-user
title: "Delete a service user"
description: "Delete a service user permanently and all of its relations (keys, organizations, roles, etc)"
sidebar_label: "Delete a service user"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Delete a service user permanently and all of its relations (keys, organizations, roles, etc)",
    "operationId": "ShieldService_DeleteServiceUser",
    "responses":
      {
        "200":
          {
