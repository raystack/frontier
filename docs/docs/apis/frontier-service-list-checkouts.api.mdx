...
api:
  {
    ...
    "parameters":
      [
        {
          "name": "billingId",
          "description": "ID of the billing account to list checkouts for",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing account to list checkouts for",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
