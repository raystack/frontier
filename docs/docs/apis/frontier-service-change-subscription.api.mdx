...
api:
  {
                ...
                "schema":
                  {
                    ...
                    "properties":
                      {
                        "plan":
                          { "type": "string", "title": "plan to change to" },
    ...
    "jsonRequestBodyExample": { "plan": "string", "immediate": true },
    "info":
      {
