---
id: frontier-service-get-organization-kyc
title: "Get KYC info of an organization"
description: "Get KYC info of an organization using ID or name"
sidebar_label: "Get KYC info of an organization"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Get KYC info of an organization using ID or name",
    "operationId": "FrontierService_GetOrganizationKyc",
    "responses":
      {
        "200":
          {
    ...
    "method": "get",
    "path": "/v1beta1/organizations/{org_id}/kyc",
    ...
    "postman":
      {
        "name": "Get KYC info of an organization",
        "description":
          {
            "content": "Get KYC info of an organization using ID or name",
            "type": "text/plain",
          },
        "url":
          {
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Path Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"org_id","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
