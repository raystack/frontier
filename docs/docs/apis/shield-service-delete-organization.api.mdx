---
id: shield-service-delete-organization
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Delete an organization and all of its relations permanently. The organization users will not be deleted from Shield.",
            "type": "text/plain",
          },
        "url":
          {
