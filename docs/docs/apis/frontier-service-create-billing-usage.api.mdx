...
api:
  {
    ...
    "parameters":
      [
        {
          "name": "billingId",
          "description": "ID of the billing account to create the transaction for",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["Usage"],
    "method": "post",
    "path": "/v1beta1/billing/{billingId}/usages",
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing account to create the transaction for",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
