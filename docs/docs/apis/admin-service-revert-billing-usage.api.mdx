---
id: admin-service-revert-billing-usage
title: "Revert billing usage"
description: "Revert billing usage for a billing account."
sidebar_label: "Revert billing usage"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "Revert billing usage for a billing account.",
    "operationId": "AdminService_RevertBillingUsage",
    "responses":
      {
        "200":
          {
    ...
    "parameters":
      [
        {
          "name": "org_id",
          "description": "either provide org_id or infer org from project_id",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
        {
          "name": "billing_id",
          "description": "either provide billing_id of the org or API can infer the default\nbilling ID from either org_id or project_id, not both",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
        {
          "name": "usage_id",
          "description": "usage id to revert, a usage can only be allowed to revert once",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["Billing"],
    "method": "post",
    "path": "/v1beta1/admin/organizations/{org_id}/billing/{billing_id}/usage/{usage_id}/revert",
    ...
    "jsonRequestBodyExample": { "project_id": "string", "amount": "string" },
    "info":
      {
    ...
    "postman":
      {
        "name": "Revert billing usage",
        "description":
          {
            "content": "Revert billing usage for a billing account.",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) either provide org_id or infer org from project_id",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) either provide billing_id of the org or API can infer the default\nbilling ID from either org_id or project_id, not both",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) usage id to revert, a usage can only be allowed to revert once",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Path Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"org_id","description":"either provide org_id or infer org from project_id","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"billing_id","description":"either provide billing_id of the org or API can infer the default\nbilling ID from either org_id or project_id, not both","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem><ParamsItem className={"paramsItem"} param={{"name":"usage_id","description":"usage id to revert, a usage can only be allowed to revert once","in":"path","required":true,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><MimeTabs><TabItem label={"application/json"} value={"application/json-schema"}><details style={{}} data-collapsed={false} open={true}><summary style={{"textAlign":"left"}}><strong>Request Body</strong><strong style={{"fontSize":"var(--ifm-code-font-size)","color":"var(--openapi-required)"}}> required</strong></summary><div style={{"textAlign":"left","marginLeft":"1rem"}}></div><ul style={{"marginLeft":"1rem"}}><SchemaItem collapsible={false} name={"project_id"} required={false} schemaName={"string"} qualifierMessage={undefined} schema={{"type":"string"}}></SchemaItem><SchemaItem collapsible={false} name={"amount"} required={false} schemaName={"int64"} qualifierMessage={undefined} schema={{"type":"string","format":"int64","title":"amount should be equal or less than the usage amount"}}></SchemaItem></ul></details></TabItem></MimeTabs><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
