...
<MimeTabs><TabItem label={"application/json"} value={"application/json-schema"}><details style={{}} data-collapsed={false} open={true}><summary style={{"textAlign":"left"}}><strong>Request Body</strong><strong style={{"fontSize":"var(--ifm-code-font-size)","color":"var(--openapi-required)"}}> required</strong></summary><div style={{"textAlign":"left","marginLeft":"1rem"}}></div><ul style={{"marginLeft":"1rem"}}><SchemaItem collapsible={false} name={"strategyName"} required={false} schemaName={"strategy_name will not be set for oidc but can be utilized for methods like email magic links"} qualifierMessage={undefined} schema={{"type":"string","title":"strategy_name will not be set for oidc but can be utilized for methods like email magic links"}}></SchemaItem><SchemaItem collapsible={false} name={"state"} required={false} schemaName={"for oidc & magic links"} qualifierMessage={undefined} schema={{"type":"string","title":"for oidc & magic links"}}></SchemaItem><SchemaItem collapsible={false} name={"code"} required={false} schemaName={"string"} qualifierMessage={undefined} schema={{"type":"string"}}></SchemaItem><SchemaItem collapsible={false} name={"stateOptions"} required={false} schemaName={"object"} qualifierMessage={undefined} schema={{"type":"object","title":"state_options has additional configurations for the authentication flow at hand\nfor example, in case of passkey, it has challenge and public key"}}></SchemaItem></ul></details></TabItem></MimeTabs><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
