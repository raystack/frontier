...
api:
  {
    ...
    "parameters":
      [
        {
          "name": "customerId",
          "description": "ID of the billing customer to get the subscription for",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) ID of the billing customer to get the subscription for",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
