---
id: frontier-service-list-billing-transactions
...
api:
  {
    "description": "List all transactions of a billing account.",
    "operationId": "FrontierService_ListBillingTransactions",
    "responses":
      {
        "200":
          {
    ...
    "tags": ["Transaction"],
    "method": "get",
    "path": "/v1beta1/organizations/{org_id}/billing/{billing_id}/transactions",
