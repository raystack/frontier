---
id: frontier-service-list-billing-customers
title: "List billing customers"
description: "List billing customers of an organization."
sidebar_label: "List billing customers"
hide_title: true
hide_table_of_contents: true
api:
  {
    "description": "List billing customers of an organization.",
    "operationId": "FrontierService_ListBillingCustomers",
    "responses":
      {
        "200":
          {
                            ...
                            "billingCustomers":
                              {
                                ...
                                "title": "List of billing customers",
                              },
                          },
                      },
                  },
    ...
    "parameters":
      [
        {
          "name": "orgId",
          "description": "ID of the organization to list billing customers for",
          "in": "query",
          "required": false,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["Billing"],
    "method": "get",
    "path": "/v1beta1/billing/customers",
    ...
    "postman":
      {
        "name": "List billing customers",
        "description":
          {
            "content": "List billing customers of an organization.",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "ID of the organization to list billing customers for",
                      "type": "text/plain",
                    },
                  "key": "orgId",
                  "value": "",
