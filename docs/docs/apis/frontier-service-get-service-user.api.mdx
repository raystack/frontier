...
api:
  {
    ...
    "parameters":
      [
        ...
        {
          "name": "id",
          "description": "The unique ID of the service user to get.",
          "in": "path",
          "required": true,
          "schema": { "type": "string" },
        },
    ...
    "tags": ["ServiceUser"],
    "method": "get",
    "path": "/v1beta1/organizations/{org_id}/serviceusers/{id}",
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Get service user details by its id.",
            "type": "text/plain",
          },
        "url":
          {
            "path":
              ["v1beta1", "organizations", ":org_id", "serviceusers", ":id"],
            "host": ["{{baseUrl}}"],
            "query": [],
            "variable":
              [
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The unique ID of the service user to get.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
