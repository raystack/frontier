...
api:
  {
    "description": "Update a role title, description and permissions.",
    "operationId": "AdminService_UpdateRole",
    "responses":
      {
        "200":
          {
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Update a role title, description and permissions.",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The role id to update.",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
