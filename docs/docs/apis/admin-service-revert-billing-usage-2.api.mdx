---
id: admin-service-revert-billing-usage-2
...
api:
  {
    "description": "Revert billing usage for a billing account.",
    "operationId": "AdminService_RevertBillingUsage2",
    "responses":
      {
        "200":
          {
                    ...
                    "properties":
                      {
                        "org_id":
                          {
                            "type": "string",
                            "title": "either provide org_id or infer org from project_id",
                          },
                        ...
                        "usage_id":
                          {
                            "type": "string",
                            "title": "usage id to revert, a usage can only be allowed to revert once",
                          },
                        "amount":
                          {
                            "type": "string",
