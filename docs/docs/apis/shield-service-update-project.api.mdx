                    ...
                    "properties":
                      {
                        "name":
                          {
                            "type": "string",
                            "description": "The name of the project. The name must be unique within the entire Shield instance. The name can contain only alphanumeric characters, dashes and underscores.<br/> *Example:* `shield-playground`",
                          },
                        "title":
                          {
                            "type": "string",
                            "description": "The title can contain any UTF-8 character, used to provide a human-readable name for the project. Can also be left empty. <br/> *Example:* `Shield Playground`",
                          },
                        "metadata":
                          {
                            "type": "object",
