...
title: "Get Organizations by User"
description: "Get all the organizations a user belongs to."
sidebar_label: "Get Organizations by User"
hide_title: true
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "Get all the organizations a user belongs to.",
            "type": "text/plain",
          },
        "url":
          {
