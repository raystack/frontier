...
var (
	...
	ErrAlreadyMember                  = errors.New("principal is already a member of the resource")
	ErrNotMember                      = errors.New("principal is not a member of the resource")
	...
	ErrLastGroupOwnerRole             = errors.New("group must have at least one owner, consider assigning another owner before changing this user's role")
	...
	ErrBillingProviderResourceMissing = errors.New("billing account is no longer linked to the payment provider")
