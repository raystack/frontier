...
func (_m *UserService) UnSudo(ctx context.Context, id string, relationName string) error {
	ret := _m.Called(ctx, id, relationName)
...
//   - id string
//   - relationName string
func (_e *UserService_Expecter) UnSudo(ctx interface{}, id interface{}, relationName interface{}) *UserService_UnSudo_Call {
	return &UserService_UnSudo_Call{Call: _e.mock.On("UnSudo", ctx, id, relationName)}
}

func (_c *UserService_UnSudo_Call) Run(run func(ctx context.Context, id string, relationName string)) *UserService_UnSudo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *UserService_UnSudo_Call) RunAndReturn(run func(context.Context, string, string) error) *UserService_UnSudo_Call {
	_c.Call.Return(run)
	return _c
}
