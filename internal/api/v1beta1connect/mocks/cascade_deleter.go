...
func (_m *CascadeDeleter) DeleteGroup(ctx context.Context, id string) error {
...
// CascadeDeleter_DeleteGroup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteGroup'
type CascadeDeleter_DeleteGroup_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - id string
func (_e *CascadeDeleter_Expecter) DeleteGroup(ctx interface{}, id interface{}) *CascadeDeleter_DeleteGroup_Call {
	return &CascadeDeleter_DeleteGroup_Call{Call: _e.mock.On("DeleteGroup", ctx, id)}
}

func (_c *CascadeDeleter_DeleteGroup_Call) Run(run func(ctx context.Context, id string)) *CascadeDeleter_DeleteGroup_Call {
...
func (_c *CascadeDeleter_DeleteGroup_Call) Return(_a0 error) *CascadeDeleter_DeleteGroup_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CascadeDeleter_DeleteGroup_Call) RunAndReturn(run func(context.Context, string) error) *CascadeDeleter_DeleteGroup_Call {
	_c.Call.Return(run)
	return _c
}
