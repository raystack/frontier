...
import (
	...
	metaschema "github.com/odpf/shield/core/metaschema"
	metadata "github.com/odpf/shield/pkg/metadata"
...
type mockConstructorTestingTNewMetaSchemaService interface {
	mock.TestingT
	Cleanup(func())
}
