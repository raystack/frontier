...
func TestUserProjectsRepository_prepareDataQuery(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantArgs:  []any{"app/project", "app/user", "org456", "user123", "app/project", "app/user", "%test%", "%test%", int64(10), int64(1)},
			wantError: false,
		},
	}
